...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ActorStartingLocationsBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ActorStartingLocationsBlockBase
    {
        ...
        internal  ActorStartingLocationsBlockBase(System.IO.BinaryReader binaryReader)
        {
