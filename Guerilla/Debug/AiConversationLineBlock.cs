...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  AiConversationLineBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class AiConversationLineBlockBase
    {
        ...
        internal  AiConversationLineBlockBase(System.IO.BinaryReader binaryReader)
        {
