...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  AiConversationParticipantBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class AiConversationParticipantBlockBase
    {
        ...
        internal  AiConversationParticipantBlockBase(System.IO.BinaryReader binaryReader)
        {
