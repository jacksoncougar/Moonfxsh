...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  AiDeafeningEncodedPasBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class AiDeafeningEncodedPasBlockBase
    {
        ...
        internal  AiDeafeningEncodedPasBlockBase(System.IO.BinaryReader binaryReader)
        {
