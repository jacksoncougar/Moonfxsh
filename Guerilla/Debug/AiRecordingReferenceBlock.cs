...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  AiRecordingReferenceBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class AiRecordingReferenceBlockBase
    {
        ...
        internal  AiRecordingReferenceBlockBase(System.IO.BinaryReader binaryReader)
        {
