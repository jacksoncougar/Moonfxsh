...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  AiScenarioMissionDialogueBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class AiScenarioMissionDialogueBlockBase
    {
        ...
        internal  AiScenarioMissionDialogueBlockBase(System.IO.BinaryReader binaryReader)
        {
