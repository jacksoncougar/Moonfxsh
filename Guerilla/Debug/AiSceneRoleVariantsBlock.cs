...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  AiSceneRoleVariantsBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class AiSceneRoleVariantsBlockBase
    {
        ...
        internal  AiSceneRoleVariantsBlockBase(System.IO.BinaryReader binaryReader)
        {
