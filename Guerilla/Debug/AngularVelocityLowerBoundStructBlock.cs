...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  AngularVelocityLowerBoundStructBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class AngularVelocityLowerBoundStructBlockBase
    {
        ...
        internal  AngularVelocityLowerBoundStructBlockBase(System.IO.BinaryReader binaryReader)
        {
