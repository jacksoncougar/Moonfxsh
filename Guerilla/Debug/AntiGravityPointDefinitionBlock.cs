...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  AntiGravityPointDefinitionBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class AntiGravityPointDefinitionBlockBase
    {
        ...
        internal  AntiGravityPointDefinitionBlockBase(System.IO.BinaryReader binaryReader)
        {
