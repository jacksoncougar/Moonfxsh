...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  BipedBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class BipedBlockBase : UnitBlock
    {
        ...
        internal  BipedBlockBase(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
            ...
            ReadContactPointBlockArray(binaryReader);
        ...
        internal  virtual ContactPointBlock[] ReadContactPointBlockArray(System.IO.BinaryReader binaryReader)
        {
        ...
        internal  virtual void WriteContactPointBlockArray(System.IO.BinaryWriter binaryWriter)
        {
        ...
        public void Write(System.IO.BinaryWriter binaryWriter)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                WriteContactPointBlockArray(binaryWriter);
