...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  BitmapBlockReferenceBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class BitmapBlockReferenceBlockBase
    {
        ...
        internal  BitmapBlockReferenceBlockBase(System.IO.BinaryReader binaryReader)
        {
