...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  BoxesBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
            
        }
    };
    [LayoutAttribute(Size = 144)]
    public class BoxesBlockBase
    {
        ...
        internal  BoxesBlockBase(System.IO.BinaryReader binaryReader)
        {
