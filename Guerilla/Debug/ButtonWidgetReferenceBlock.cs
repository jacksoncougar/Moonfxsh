...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ButtonWidgetReferenceBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ButtonWidgetReferenceBlockBase
    {
        ...
        internal  ButtonWidgetReferenceBlockBase(System.IO.BinaryReader binaryReader)
        {
