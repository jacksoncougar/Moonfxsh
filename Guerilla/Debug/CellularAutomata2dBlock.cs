...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  CellularAutomata2dBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class CellularAutomata2dBlockBase
    {
        ...
        internal  CellularAutomata2dBlockBase(System.IO.BinaryReader binaryReader)
        {
            ...
            ReadRulesBlockArray(binaryReader);
        }
        ...
        internal  virtual RulesBlock[] ReadRulesBlockArray(System.IO.BinaryReader binaryReader)
        {
        ...
        internal  virtual void WriteRulesBlockArray(System.IO.BinaryWriter binaryWriter)
        {
        ...
        public void Write(System.IO.BinaryWriter binaryWriter)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                WriteRulesBlockArray(binaryWriter);
            }
        }
        [FlagsAttribute]
