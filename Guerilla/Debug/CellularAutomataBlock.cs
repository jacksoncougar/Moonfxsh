...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  CellularAutomataBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class CellularAutomataBlockBase
    {
        ...
        internal  CellularAutomataBlockBase(System.IO.BinaryReader binaryReader)
        {
