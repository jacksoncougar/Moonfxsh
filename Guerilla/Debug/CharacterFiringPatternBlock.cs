...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  CharacterFiringPatternBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class CharacterFiringPatternBlockBase
    {
        ...
        internal  CharacterFiringPatternBlockBase(System.IO.BinaryReader binaryReader)
        {
