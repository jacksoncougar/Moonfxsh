...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  CharacterGeneralBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class CharacterGeneralBlockBase
    {
        ...
        internal  CharacterGeneralBlockBase(System.IO.BinaryReader binaryReader)
        {
