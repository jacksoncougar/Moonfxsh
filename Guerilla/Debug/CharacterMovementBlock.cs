...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  CharacterMovementBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class CharacterMovementBlockBase
    {
        ...
        internal  CharacterMovementBlockBase(System.IO.BinaryReader binaryReader)
        {
