...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  CharacterPerceptionBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class CharacterPerceptionBlockBase
    {
        ...
        internal  CharacterPerceptionBlockBase(System.IO.BinaryReader binaryReader)
        {
