...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  CharacterRetreatBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class CharacterRetreatBlockBase
    {
        ...
        internal  CharacterRetreatBlockBase(System.IO.BinaryReader binaryReader)
        {
