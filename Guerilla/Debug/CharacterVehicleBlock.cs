...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  CharacterVehicleBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class CharacterVehicleBlockBase
    {
        ...
        internal  CharacterVehicleBlockBase(System.IO.BinaryReader binaryReader)
        {
