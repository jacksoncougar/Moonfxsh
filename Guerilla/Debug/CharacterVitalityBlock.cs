...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  CharacterVitalityBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class CharacterVitalityBlockBase
    {
        ...
        internal  CharacterVitalityBlockBase(System.IO.BinaryReader binaryReader)
        {
