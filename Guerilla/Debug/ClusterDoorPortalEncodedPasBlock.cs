...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ClusterDoorPortalEncodedPasBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ClusterDoorPortalEncodedPasBlockBase
    {
        ...
        internal  ClusterDoorPortalEncodedPasBlockBase(System.IO.BinaryReader binaryReader)
        {
