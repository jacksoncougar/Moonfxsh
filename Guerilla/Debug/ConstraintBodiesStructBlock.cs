...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ConstraintBodiesStructBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ConstraintBodiesStructBlockBase
    {
        ...
        internal  ConstraintBodiesStructBlockBase(System.IO.BinaryReader binaryReader)
        {
