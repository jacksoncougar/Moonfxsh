...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ContrailBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ContrailBlockBase
    {
        ...
        internal  ContrailBlockBase(System.IO.BinaryReader binaryReader)
        {
            ...
            ReadContrailPointStatesBlockArray(binaryReader);
        }
        ...
        internal  virtual ContrailPointStatesBlock[] ReadContrailPointStatesBlockArray(System.IO.BinaryReader binaryReader)
        {
            var elementSize = Deserializer.SizeOf(typeof(ContrailPointStatesBlock));
            var blamPointer = binaryReader.ReadBlamPointer(elementSize);
            var array = new ContrailPointStatesBlock[blamPointer.Count];
            using (binaryReader.BaseStream.Pin())
            {
        ...
        internal  virtual void WriteContrailPointStatesBlockArray(System.IO.BinaryWriter binaryWriter)
        {
        ...
        public void Write(System.IO.BinaryWriter binaryWriter)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                WriteContrailPointStatesBlockArray(binaryWriter);
            }
        }
        [FlagsAttribute]
