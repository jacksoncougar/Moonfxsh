...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  CreatureBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class CreatureBlockBase : ObjectBlock
    {
        ...
        internal  CreatureBlockBase(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
