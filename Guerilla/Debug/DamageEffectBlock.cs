...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  DamageEffectBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class DamageEffectBlockBase
    {
        ...
        internal  DamageEffectBlockBase(System.IO.BinaryReader binaryReader)
        {
            ...
            ReadDamageEffectPlayerResponseBlockArray(binaryReader);
        ...
        internal  virtual DamageEffectPlayerResponseBlock[] ReadDamageEffectPlayerResponseBlockArray(System.IO.BinaryReader binaryReader)
        {
            var elementSize = Deserializer.SizeOf(typeof(DamageEffectPlayerResponseBlock));
            var blamPointer = binaryReader.ReadBlamPointer(elementSize);
            var array = new DamageEffectPlayerResponseBlock[blamPointer.Count];
            using (binaryReader.BaseStream.Pin())
            {
        ...
        internal  virtual void WriteDamageEffectPlayerResponseBlockArray(System.IO.BinaryWriter binaryWriter)
        {
        ...
        public void Write(System.IO.BinaryWriter binaryWriter)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                WriteDamageEffectPlayerResponseBlockArray(binaryWriter);
