...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  DamageRegionBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
            
        }
    };
    [LayoutAttribute(Size = 4)]
    public class DamageRegionBlockBase
    {
        internal AnimationIndexStructBlock animation;
        internal  DamageRegionBlockBase(System.IO.BinaryReader binaryReader)
        {
