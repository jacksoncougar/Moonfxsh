...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  DecoratorModelIndicesBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class DecoratorModelIndicesBlockBase
    {
        ...
        internal  DecoratorModelIndicesBlockBase(System.IO.BinaryReader binaryReader)
        {
