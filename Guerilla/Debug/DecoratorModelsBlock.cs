...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  DecoratorModelsBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class DecoratorModelsBlockBase
    {
        ...
        internal  DecoratorModelsBlockBase(System.IO.BinaryReader binaryReader)
        {
