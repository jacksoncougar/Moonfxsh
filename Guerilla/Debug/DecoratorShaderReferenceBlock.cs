...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  DecoratorShaderReferenceBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class DecoratorShaderReferenceBlockBase
    {
        ...
        internal  DecoratorShaderReferenceBlockBase(System.IO.BinaryReader binaryReader)
        {
