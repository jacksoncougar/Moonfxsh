...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  DeviceBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class DeviceBlockBase : ObjectBlock
    {
        ...
        internal  DeviceBlockBase(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
