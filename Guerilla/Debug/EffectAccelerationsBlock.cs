...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  EffectAccelerationsBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class EffectAccelerationsBlockBase
    {
        ...
        internal  EffectAccelerationsBlockBase(System.IO.BinaryReader binaryReader)
        {
