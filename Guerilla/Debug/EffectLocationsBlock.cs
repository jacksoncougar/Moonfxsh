...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  EffectLocationsBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class EffectLocationsBlockBase
    {
        ...
        internal  EffectLocationsBlockBase(System.IO.BinaryReader binaryReader)
        {
