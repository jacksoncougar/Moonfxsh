...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  EncodedClusterDistancesBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class EncodedClusterDistancesBlockBase
    {
        ...
        internal  EncodedClusterDistancesBlockBase(System.IO.BinaryReader binaryReader)
        {
