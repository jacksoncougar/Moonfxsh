...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ErrorReportLinesBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ErrorReportLinesBlockBase
    {
        ...
        internal  ErrorReportLinesBlockBase(System.IO.BinaryReader binaryReader)
        {
