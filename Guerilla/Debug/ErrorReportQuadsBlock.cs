...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ErrorReportQuadsBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ErrorReportQuadsBlockBase
    {
        ...
        internal  ErrorReportQuadsBlockBase(System.IO.BinaryReader binaryReader)
        {
