...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ErrorReportVerticesBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ErrorReportVerticesBlockBase
    {
        ...
        internal  ErrorReportVerticesBlockBase(System.IO.BinaryReader binaryReader)
        {
