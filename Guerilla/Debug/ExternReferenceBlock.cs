...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ExternReferenceBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ExternReferenceBlockBase
    {
        ...
        internal  ExternReferenceBlockBase(System.IO.BinaryReader binaryReader)
        {
