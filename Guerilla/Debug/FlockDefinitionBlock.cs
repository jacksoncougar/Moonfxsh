...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  FlockDefinitionBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class FlockDefinitionBlockBase
    {
        ...
        internal  FlockDefinitionBlockBase(System.IO.BinaryReader binaryReader)
        {
            ...
            ReadFlockSourceBlockArray(binaryReader);
            ReadFlockSinkBlockArray(binaryReader);
        ...
        internal  virtual FlockSourceBlock[] ReadFlockSourceBlockArray(System.IO.BinaryReader binaryReader)
        {
        ...
        internal  virtual FlockSinkBlock[] ReadFlockSinkBlockArray(System.IO.BinaryReader binaryReader)
        {
        ...
        internal  virtual void WriteFlockSourceBlockArray(System.IO.BinaryWriter binaryWriter)
        {
            
        }
        internal  virtual void WriteFlockSinkBlockArray(System.IO.BinaryWriter binaryWriter)
        {
        ...
        public void Write(System.IO.BinaryWriter binaryWriter)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                WriteFlockSourceBlockArray(binaryWriter);
                WriteFlockSinkBlockArray(binaryWriter);
