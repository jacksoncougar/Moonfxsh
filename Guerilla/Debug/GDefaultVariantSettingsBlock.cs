...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  GDefaultVariantSettingsBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class GDefaultVariantSettingsBlockBase
    {
        ...
        internal int value;
        internal  GDefaultVariantSettingsBlockBase(System.IO.BinaryReader binaryReader)
        {
