...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  GameEngineAssaultEventBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
            
        }
    };
    [LayoutAttribute(Size = 168)]
    public class GameEngineAssaultEventBlockBase
    {
        ...
        internal  GameEngineAssaultEventBlockBase(System.IO.BinaryReader binaryReader)
        {
