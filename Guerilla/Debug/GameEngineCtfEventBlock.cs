...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  GameEngineCtfEventBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
            
        }
    };
    [LayoutAttribute(Size = 168)]
    public class GameEngineCtfEventBlockBase
    {
        ...
        internal  GameEngineCtfEventBlockBase(System.IO.BinaryReader binaryReader)
        {
