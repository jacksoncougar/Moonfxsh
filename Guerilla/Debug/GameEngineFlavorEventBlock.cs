...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  GameEngineFlavorEventBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
            
        }
    };
    [LayoutAttribute(Size = 168)]
    public class GameEngineFlavorEventBlockBase
    {
        ...
        internal  GameEngineFlavorEventBlockBase(System.IO.BinaryReader binaryReader)
        {
