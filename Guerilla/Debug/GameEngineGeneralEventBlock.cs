...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  GameEngineGeneralEventBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class GameEngineGeneralEventBlockBase
    {
        ...
        internal  GameEngineGeneralEventBlockBase(System.IO.BinaryReader binaryReader)
        {
