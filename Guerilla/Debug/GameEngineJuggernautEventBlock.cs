...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  GameEngineJuggernautEventBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
            
        }
    };
    [LayoutAttribute(Size = 168)]
    public class GameEngineJuggernautEventBlockBase
    {
        ...
        internal  GameEngineJuggernautEventBlockBase(System.IO.BinaryReader binaryReader)
        {
