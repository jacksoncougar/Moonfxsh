...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  GameEngineKingEventBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class GameEngineKingEventBlockBase
    {
        ...
        internal  GameEngineKingEventBlockBase(System.IO.BinaryReader binaryReader)
        {
