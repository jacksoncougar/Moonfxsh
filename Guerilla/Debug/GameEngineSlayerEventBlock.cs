...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  GameEngineSlayerEventBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
            
        }
    };
    [LayoutAttribute(Size = 168)]
    public class GameEngineSlayerEventBlockBase
    {
        ...
        internal  GameEngineSlayerEventBlockBase(System.IO.BinaryReader binaryReader)
        {
