...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  GameEngineStatusResponseBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class GameEngineStatusResponseBlockBase
    {
        ...
        internal  GameEngineStatusResponseBlockBase(System.IO.BinaryReader binaryReader)
        {
