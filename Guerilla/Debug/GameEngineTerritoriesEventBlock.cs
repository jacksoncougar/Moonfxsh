...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  GameEngineTerritoriesEventBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
            
        }
    };
    [LayoutAttribute(Size = 168)]
    public class GameEngineTerritoriesEventBlockBase
    {
        ...
        internal  GameEngineTerritoriesEventBlockBase(System.IO.BinaryReader binaryReader)
        {
