...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  GamePortalToPortalMappingBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class GamePortalToPortalMappingBlockBase
    {
        ...
        internal  GamePortalToPortalMappingBlockBase(System.IO.BinaryReader binaryReader)
        {
