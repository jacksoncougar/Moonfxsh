...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  GlobalCollisionBspBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class GlobalCollisionBspBlockBase
    {
        ...
        internal  GlobalCollisionBspBlockBase(System.IO.BinaryReader binaryReader)
        {
