...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  GlobalDetailObjectCellsBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class GlobalDetailObjectCellsBlockBase
    {
        ...
        internal  GlobalDetailObjectCellsBlockBase(System.IO.BinaryReader binaryReader)
        {
