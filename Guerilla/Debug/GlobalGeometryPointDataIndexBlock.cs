...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  GlobalGeometryPointDataIndexBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class GlobalGeometryPointDataIndexBlockBase
    {
        ...
        internal  GlobalGeometryPointDataIndexBlockBase(System.IO.BinaryReader binaryReader)
        {
