...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  GlobalGeometrySectionRawVertexBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class GlobalGeometrySectionRawVertexBlockBase
    {
        ...
        internal  GlobalGeometrySectionRawVertexBlockBase(System.IO.BinaryReader binaryReader)
        {
