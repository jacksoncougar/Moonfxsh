...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  GlobalGeometrySectionStripIndexBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class GlobalGeometrySectionStripIndexBlockBase
    {
        ...
        internal  GlobalGeometrySectionStripIndexBlockBase(System.IO.BinaryReader binaryReader)
        {
