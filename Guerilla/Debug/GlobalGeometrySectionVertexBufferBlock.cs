...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  GlobalGeometrySectionVertexBufferBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class GlobalGeometrySectionVertexBufferBlockBase
    {
        ...
        internal  GlobalGeometrySectionVertexBufferBlockBase(System.IO.BinaryReader binaryReader)
        {
