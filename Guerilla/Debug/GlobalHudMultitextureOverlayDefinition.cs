...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  GlobalHudMultitextureOverlayDefinition(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class GlobalHudMultitextureOverlayDefinitionBase
    {
        ...
        internal  GlobalHudMultitextureOverlayDefinitionBase(System.IO.BinaryReader binaryReader)
        {
            ...
            ReadGlobalHudMultitextureOverlayEffectorDefinitionArray(binaryReader);
        ...
        internal  virtual GlobalHudMultitextureOverlayEffectorDefinition[] ReadGlobalHudMultitextureOverlayEffectorDefinitionArray(System.IO.BinaryReader binaryReader)
        {
        ...
        internal  virtual void WriteGlobalHudMultitextureOverlayEffectorDefinitionArray(System.IO.BinaryWriter binaryWriter)
        {
        ...
        public void Write(System.IO.BinaryWriter binaryWriter)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                WriteGlobalHudMultitextureOverlayEffectorDefinitionArray(binaryWriter);
