...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  GlobalHudScreenEffectDefinition(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class GlobalHudScreenEffectDefinitionBase
    {
        ...
        internal  GlobalHudScreenEffectDefinitionBase(System.IO.BinaryReader binaryReader)
        {
