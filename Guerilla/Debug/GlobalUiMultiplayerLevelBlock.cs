...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  GlobalUiMultiplayerLevelBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class GlobalUiMultiplayerLevelBlockBase
    {
        ...
        internal  GlobalUiMultiplayerLevelBlockBase(System.IO.BinaryReader binaryReader)
        {
