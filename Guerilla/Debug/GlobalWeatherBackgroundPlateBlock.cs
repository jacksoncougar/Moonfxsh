...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  GlobalWeatherBackgroundPlateBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class GlobalWeatherBackgroundPlateBlockBase
    {
        ...
        internal  GlobalWeatherBackgroundPlateBlockBase(System.IO.BinaryReader binaryReader)
        {
