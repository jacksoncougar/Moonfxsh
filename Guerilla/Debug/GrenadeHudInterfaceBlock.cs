...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  GrenadeHudInterfaceBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class GrenadeHudInterfaceBlockBase
    {
        ...
        internal  GrenadeHudInterfaceBlockBase(System.IO.BinaryReader binaryReader)
        {
            ...
            ReadGrenadeHudOverlayBlockArray(binaryReader);
            ReadGrenadeHudSoundBlockArray(binaryReader);
        ...
        internal  virtual GrenadeHudOverlayBlock[] ReadGrenadeHudOverlayBlockArray(System.IO.BinaryReader binaryReader)
        {
            var elementSize = Deserializer.SizeOf(typeof(GrenadeHudOverlayBlock));
            var blamPointer = binaryReader.ReadBlamPointer(elementSize);
            var array = new GrenadeHudOverlayBlock[blamPointer.Count];
            using (binaryReader.BaseStream.Pin())
            {
                for (int i = 0; i < blamPointer.Count; ++i)
                {
        ...
        internal  virtual GrenadeHudSoundBlock[] ReadGrenadeHudSoundBlockArray(System.IO.BinaryReader binaryReader)
        {
            var elementSize = Deserializer.SizeOf(typeof(GrenadeHudSoundBlock));
            var blamPointer = binaryReader.ReadBlamPointer(elementSize);
            var array = new GrenadeHudSoundBlock[blamPointer.Count];
            using (binaryReader.BaseStream.Pin())
            {
                for (int i = 0; i < blamPointer.Count; ++i)
                {
        ...
        internal  virtual void WriteGrenadeHudOverlayBlockArray(System.IO.BinaryWriter binaryWriter)
        {
            
        }
        internal  virtual void WriteGrenadeHudSoundBlockArray(System.IO.BinaryWriter binaryWriter)
        {
        ...
        public void Write(System.IO.BinaryWriter binaryWriter)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                WriteGrenadeHudOverlayBlockArray(binaryWriter);
                WriteGrenadeHudSoundBlockArray(binaryWriter);
