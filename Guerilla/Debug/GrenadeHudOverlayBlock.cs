...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  GrenadeHudOverlayBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
            
        }
    };
    [LayoutAttribute(Size = 136)]
    public class GrenadeHudOverlayBlockBase
    {
        ...
        internal  GrenadeHudOverlayBlockBase(System.IO.BinaryReader binaryReader)
        {
