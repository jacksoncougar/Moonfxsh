...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  HavokCleanupResourcesBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class HavokCleanupResourcesBlockBase
    {
        ...
        internal  HavokCleanupResourcesBlockBase(System.IO.BinaryReader binaryReader)
        {
