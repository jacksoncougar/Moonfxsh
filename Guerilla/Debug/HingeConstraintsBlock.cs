...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  HingeConstraintsBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
            
        }
    };
    [LayoutAttribute(Size = 120)]
    public class HingeConstraintsBlockBase
    {
        internal ConstraintBodiesStructBlock constraintBodies;
        internal byte[] invalidName_;
        internal  HingeConstraintsBlockBase(System.IO.BinaryReader binaryReader)
        {
