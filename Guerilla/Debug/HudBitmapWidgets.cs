...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  HudBitmapWidgets(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class HudBitmapWidgetsBase
    {
        ...
        internal  HudBitmapWidgetsBase(System.IO.BinaryReader binaryReader)
        {
            ...
            ReadHudWidgetEffectBlockArray(binaryReader);
        ...
        internal  virtual HudWidgetEffectBlock[] ReadHudWidgetEffectBlockArray(System.IO.BinaryReader binaryReader)
        {
        ...
        internal  virtual void WriteHudWidgetEffectBlockArray(System.IO.BinaryWriter binaryWriter)
        {
        ...
        public void Write(System.IO.BinaryWriter binaryWriter)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                WriteHudWidgetEffectBlockArray(binaryWriter);
