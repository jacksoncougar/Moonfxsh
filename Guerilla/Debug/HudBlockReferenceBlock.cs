...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  HudBlockReferenceBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class HudBlockReferenceBlockBase
    {
        ...
        internal  HudBlockReferenceBlockBase(System.IO.BinaryReader binaryReader)
        {
