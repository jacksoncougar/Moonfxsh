...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  HudGlobalsBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class HudGlobalsBlockBase
    {
        ...
        internal  HudGlobalsBlockBase(System.IO.BinaryReader binaryReader)
        {
            ...
            ReadHudButtonIconBlockArray(binaryReader);
        ...
        internal  virtual HudButtonIconBlock[] ReadHudButtonIconBlockArray(System.IO.BinaryReader binaryReader)
        {
            var elementSize = Deserializer.SizeOf(typeof(HudButtonIconBlock));
            var blamPointer = binaryReader.ReadBlamPointer(elementSize);
            var array = new HudButtonIconBlock[blamPointer.Count];
            using (binaryReader.BaseStream.Pin())
            {
        ...
        internal  virtual void WriteHudButtonIconBlockArray(System.IO.BinaryWriter binaryWriter)
        {
        ...
        public void Write(System.IO.BinaryWriter binaryWriter)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                WriteHudButtonIconBlockArray(binaryWriter);
