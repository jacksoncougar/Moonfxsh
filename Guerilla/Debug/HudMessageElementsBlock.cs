...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  HudMessageElementsBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class HudMessageElementsBlockBase
    {
        internal byte type;
        internal byte data;
        internal  HudMessageElementsBlockBase(System.IO.BinaryReader binaryReader)
        {
