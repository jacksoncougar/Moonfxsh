...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  HudWidgetEffectFunctionStructBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
            
        }
    };
    [LayoutAttribute(Size = 20)]
    public class HudWidgetEffectFunctionStructBlockBase
    {
        ...
        internal  HudWidgetEffectFunctionStructBlockBase(System.IO.BinaryReader binaryReader)
        {
