...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  HudWidgetStateDefinitionStructBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class HudWidgetStateDefinitionStructBlockBase
    {
        ...
        internal  HudWidgetStateDefinitionStructBlockBase(System.IO.BinaryReader binaryReader)
        {
