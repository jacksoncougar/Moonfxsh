...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  InheritedAnimationNodeMapBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class InheritedAnimationNodeMapBlockBase
    {
        ...
        internal  InheritedAnimationNodeMapBlockBase(System.IO.BinaryReader binaryReader)
        {
