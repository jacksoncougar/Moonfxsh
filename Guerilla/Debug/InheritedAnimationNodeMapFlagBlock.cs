...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  InheritedAnimationNodeMapFlagBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class InheritedAnimationNodeMapFlagBlockBase
    {
        ...
        internal  InheritedAnimationNodeMapFlagBlockBase(System.IO.BinaryReader binaryReader)
        {
