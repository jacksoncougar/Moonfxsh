...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  InstancedGeometryReferenceBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class InstancedGeometryReferenceBlockBase
    {
        ...
        internal  InstancedGeometryReferenceBlockBase(System.IO.BinaryReader binaryReader)
        {
