...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  InstantaneousDamageRepsonseBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class InstantaneousDamageRepsonseBlockBase
    {
        ...
        internal  InstantaneousDamageRepsonseBlockBase(System.IO.BinaryReader binaryReader)
        {
