...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  InstantaneousResponseDamageEffectMarkerStructBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class InstantaneousResponseDamageEffectMarkerStructBlockBase
    {
        ...
        internal  InstantaneousResponseDamageEffectMarkerStructBlockBase(System.IO.BinaryReader binaryReader)
        {
