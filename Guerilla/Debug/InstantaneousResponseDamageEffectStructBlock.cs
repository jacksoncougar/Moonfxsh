...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  InstantaneousResponseDamageEffectStructBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class InstantaneousResponseDamageEffectStructBlockBase
    {
        ...
        internal  InstantaneousResponseDamageEffectStructBlockBase(System.IO.BinaryReader binaryReader)
        {
