...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  InterfaceTagReferences(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class InterfaceTagReferencesBase
    {
        ...
        internal  InterfaceTagReferencesBase(System.IO.BinaryReader binaryReader)
        {
