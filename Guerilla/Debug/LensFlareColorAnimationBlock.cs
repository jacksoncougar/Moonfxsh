...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  LensFlareColorAnimationBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class LensFlareColorAnimationBlockBase
    {
        ...
        internal  LensFlareColorAnimationBlockBase(System.IO.BinaryReader binaryReader)
        {
