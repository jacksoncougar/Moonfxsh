...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  LightBrightnessAnimationBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class LightBrightnessAnimationBlockBase
    {
        ...
        internal  LightBrightnessAnimationBlockBase(System.IO.BinaryReader binaryReader)
        {
