...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  LightmapGeometrySectionCacheDataBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class LightmapGeometrySectionCacheDataBlockBase
    {
        ...
        internal  LightmapGeometrySectionCacheDataBlockBase(System.IO.BinaryReader binaryReader)
        {
