...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  LightmapInstanceBucketSectionOffsetBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class LightmapInstanceBucketSectionOffsetBlockBase
    {
        ...
        internal  LightmapInstanceBucketSectionOffsetBlockBase(System.IO.BinaryReader binaryReader)
        {
