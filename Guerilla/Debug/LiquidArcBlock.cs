...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  LiquidArcBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class LiquidArcBlockBase
    {
        ...
        internal  LiquidArcBlockBase(System.IO.BinaryReader binaryReader)
        {
            ...
            ReadLiquidCoreBlockArray(binaryReader);
        ...
        internal  virtual LiquidCoreBlock[] ReadLiquidCoreBlockArray(System.IO.BinaryReader binaryReader)
        {
        ...
        internal  virtual void WriteLiquidCoreBlockArray(System.IO.BinaryWriter binaryWriter)
        {
        ...
        public void Write(System.IO.BinaryWriter binaryWriter)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                WriteLiquidCoreBlockArray(binaryWriter);
