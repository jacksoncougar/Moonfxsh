...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  LocalStringIdListStringReferenceBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class LocalStringIdListStringReferenceBlockBase
    {
        ...
        internal  LocalStringIdListStringReferenceBlockBase(System.IO.BinaryReader binaryReader)
        {
