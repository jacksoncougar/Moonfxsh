...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  LoopingSoundTrackBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class LoopingSoundTrackBlockBase
    {
        ...
        internal  LoopingSoundTrackBlockBase(System.IO.BinaryReader binaryReader)
        {
