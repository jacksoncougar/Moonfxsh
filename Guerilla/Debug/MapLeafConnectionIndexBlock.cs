...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  MapLeafConnectionIndexBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class MapLeafConnectionIndexBlockBase
    {
        ...
        internal  MapLeafConnectionIndexBlockBase(System.IO.BinaryReader binaryReader)
        {
