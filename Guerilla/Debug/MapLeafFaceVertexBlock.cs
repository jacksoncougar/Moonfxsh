...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  MapLeafFaceVertexBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class MapLeafFaceVertexBlockBase
    {
        ...
        internal  MapLeafFaceVertexBlockBase(System.IO.BinaryReader binaryReader)
        {
