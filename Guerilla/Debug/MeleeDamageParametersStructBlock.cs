...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  MeleeDamageParametersStructBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class MeleeDamageParametersStructBlockBase
    {
        ...
        internal  MeleeDamageParametersStructBlockBase(System.IO.BinaryReader binaryReader)
        {
