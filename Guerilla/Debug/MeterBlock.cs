...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  MeterBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class MeterBlockBase
    {
        ...
        internal  MeterBlockBase(System.IO.BinaryReader binaryReader)
        {
            ...
            encodedStencil = ReadData(binaryReader);
        }
