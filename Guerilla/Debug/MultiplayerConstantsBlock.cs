...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  MultiplayerConstantsBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class MultiplayerConstantsBlockBase
    {
        ...
        internal  MultiplayerConstantsBlockBase(System.IO.BinaryReader binaryReader)
        {
