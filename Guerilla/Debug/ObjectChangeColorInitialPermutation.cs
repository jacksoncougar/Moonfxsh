...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ObjectChangeColorInitialPermutation(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ObjectChangeColorInitialPermutationBase
    {
        ...
        internal  ObjectChangeColorInitialPermutationBase(System.IO.BinaryReader binaryReader)
        {
