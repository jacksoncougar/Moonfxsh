...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  OccluderToMachineDoorMapping(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class OccluderToMachineDoorMappingBase
    {
        ...
        internal  OccluderToMachineDoorMappingBase(System.IO.BinaryReader binaryReader)
        {
