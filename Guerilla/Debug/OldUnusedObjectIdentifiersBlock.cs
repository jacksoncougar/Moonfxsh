...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  OldUnusedObjectIdentifiersBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class OldUnusedObjectIdentifiersBlockBase
    {
        ...
        internal  OldUnusedObjectIdentifiersBlockBase(System.IO.BinaryReader binaryReader)
        {
