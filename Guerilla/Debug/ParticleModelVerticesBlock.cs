...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ParticleModelVerticesBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ParticleModelVerticesBlockBase
    {
        ...
        internal  ParticleModelVerticesBlockBase(System.IO.BinaryReader binaryReader)
        {
