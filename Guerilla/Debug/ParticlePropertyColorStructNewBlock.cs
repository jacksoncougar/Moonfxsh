...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ParticlePropertyColorStructNewBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ParticlePropertyColorStructNewBlockBase
    {
        ...
        internal  ParticlePropertyColorStructNewBlockBase(System.IO.BinaryReader binaryReader)
        {
