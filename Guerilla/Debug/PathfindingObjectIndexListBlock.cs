...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  PathfindingObjectIndexListBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class PathfindingObjectIndexListBlockBase
    {
        ...
        internal  PathfindingObjectIndexListBlockBase(System.IO.BinaryReader binaryReader)
        {
