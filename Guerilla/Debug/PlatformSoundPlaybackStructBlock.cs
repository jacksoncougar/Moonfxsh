...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  PlatformSoundPlaybackStructBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class PlatformSoundPlaybackStructBlockBase
    {
        ...
        internal  PlatformSoundPlaybackStructBlockBase(System.IO.BinaryReader binaryReader)
        {
