...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  PlayerControlBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class PlayerControlBlockBase
    {
        ...
        internal  PlayerControlBlockBase(System.IO.BinaryReader binaryReader)
        {
            ...
            ReadLookFunctionBlockArray(binaryReader);
        ...
        internal  virtual LookFunctionBlock[] ReadLookFunctionBlockArray(System.IO.BinaryReader binaryReader)
        {
        ...
        internal  virtual void WriteLookFunctionBlockArray(System.IO.BinaryWriter binaryWriter)
        {
        ...
        public void Write(System.IO.BinaryWriter binaryWriter)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                WriteLookFunctionBlockArray(binaryWriter);
