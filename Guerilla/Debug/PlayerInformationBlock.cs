...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  PlayerInformationBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class PlayerInformationBlockBase
    {
        ...
        internal  PlayerInformationBlockBase(System.IO.BinaryReader binaryReader)
        {
