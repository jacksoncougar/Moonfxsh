...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  PoweredMassPointBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class PoweredMassPointBlockBase
    {
        ...
        internal  PoweredMassPointBlockBase(System.IO.BinaryReader binaryReader)
        {
