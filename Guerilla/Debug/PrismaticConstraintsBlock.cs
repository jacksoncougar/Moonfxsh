...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  PrismaticConstraintsBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class PrismaticConstraintsBlockBase
    {
        ...
        internal  PrismaticConstraintsBlockBase(System.IO.BinaryReader binaryReader)
        {
