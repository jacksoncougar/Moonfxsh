...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ProjectileBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ProjectileBlockBase : ObjectBlock
    {
        ...
        internal  ProjectileBlockBase(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
            ...
            ReadProjectileMaterialResponseBlockArray(binaryReader);
        }
        ...
        internal  virtual ProjectileMaterialResponseBlock[] ReadProjectileMaterialResponseBlockArray(System.IO.BinaryReader binaryReader)
        {
            var elementSize = Deserializer.SizeOf(typeof(ProjectileMaterialResponseBlock));
            var blamPointer = binaryReader.ReadBlamPointer(elementSize);
            var array = new ProjectileMaterialResponseBlock[blamPointer.Count];
            using (binaryReader.BaseStream.Pin())
            {
        ...
        internal  virtual void WriteProjectileMaterialResponseBlockArray(System.IO.BinaryWriter binaryWriter)
        {
        ...
        public void Write(System.IO.BinaryWriter binaryWriter)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                WriteProjectileMaterialResponseBlockArray(binaryWriter);
            }
        }
        [FlagsAttribute]
