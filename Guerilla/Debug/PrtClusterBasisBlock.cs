...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  PrtClusterBasisBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class PrtClusterBasisBlockBase
    {
        ...
        internal  PrtClusterBasisBlockBase(System.IO.BinaryReader binaryReader)
        {
