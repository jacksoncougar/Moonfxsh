...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  RasterizerDataBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class RasterizerDataBlockBase
    {
        ...
        internal  RasterizerDataBlockBase(System.IO.BinaryReader binaryReader)
        {
            ...
            ReadVertexShaderReferenceBlockArray(binaryReader);
        ...
        internal  virtual VertexShaderReferenceBlock[] ReadVertexShaderReferenceBlockArray(System.IO.BinaryReader binaryReader)
        {
            var elementSize = Deserializer.SizeOf(typeof(VertexShaderReferenceBlock));
            var blamPointer = binaryReader.ReadBlamPointer(elementSize);
            var array = new VertexShaderReferenceBlock[blamPointer.Count];
            using (binaryReader.BaseStream.Pin())
            {
        ...
        internal  virtual void WriteVertexShaderReferenceBlockArray(System.IO.BinaryWriter binaryWriter)
        {
        ...
        public void Write(System.IO.BinaryWriter binaryWriter)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                WriteVertexShaderReferenceBlockArray(binaryWriter);
