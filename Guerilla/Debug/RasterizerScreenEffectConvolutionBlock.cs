...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  RasterizerScreenEffectConvolutionBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class RasterizerScreenEffectConvolutionBlockBase
    {
        ...
        internal  RasterizerScreenEffectConvolutionBlockBase(System.IO.BinaryReader binaryReader)
        {
