...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  RenderModelInvalidSectionPairsBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    {
        internal int bits;
        internal  RenderModelInvalidSectionPairsBlockBase(System.IO.BinaryReader binaryReader)
        {
