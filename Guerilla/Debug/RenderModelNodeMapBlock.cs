...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  RenderModelNodeMapBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class RenderModelNodeMapBlockBase
    {
        ...
        internal  RenderModelNodeMapBlockBase(System.IO.BinaryReader binaryReader)
        {
