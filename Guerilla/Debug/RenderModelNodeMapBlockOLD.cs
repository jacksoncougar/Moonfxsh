...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  RenderModelNodeMapBlockOLD(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class RenderModelNodeMapBlockOLDBase
    {
        ...
        internal  RenderModelNodeMapBlockOLDBase(System.IO.BinaryReader binaryReader)
        {
