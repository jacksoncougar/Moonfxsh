...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  RigidBodyIndicesBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class RigidBodyIndicesBlockBase
    {
        ...
        internal  RigidBodyIndicesBlockBase(System.IO.BinaryReader binaryReader)
        {
