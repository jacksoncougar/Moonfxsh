...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScalarFunctionStructBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScalarFunctionStructBlockBase
    {
        ...
        internal  ScalarFunctionStructBlockBase(System.IO.BinaryReader binaryReader)
        {
