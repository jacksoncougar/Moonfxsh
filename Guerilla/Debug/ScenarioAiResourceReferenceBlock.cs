...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScenarioAiResourceReferenceBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScenarioAiResourceReferenceBlockBase
    {
        ...
        internal  ScenarioAiResourceReferenceBlockBase(System.IO.BinaryReader binaryReader)
        {
