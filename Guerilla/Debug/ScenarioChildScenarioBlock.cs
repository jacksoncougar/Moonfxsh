...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScenarioChildScenarioBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScenarioChildScenarioBlockBase
    {
        ...
        internal  ScenarioChildScenarioBlockBase(System.IO.BinaryReader binaryReader)
        {
