...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScenarioClusterAtmosphericFogPropertiesBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScenarioClusterAtmosphericFogPropertiesBlockBase
    {
        ...
        internal  ScenarioClusterAtmosphericFogPropertiesBlockBase(System.IO.BinaryReader binaryReader)
        {
