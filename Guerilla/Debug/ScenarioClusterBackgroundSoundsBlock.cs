...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScenarioClusterBackgroundSoundsBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScenarioClusterBackgroundSoundsBlockBase
    {
        ...
        internal  ScenarioClusterBackgroundSoundsBlockBase(System.IO.BinaryReader binaryReader)
        {
