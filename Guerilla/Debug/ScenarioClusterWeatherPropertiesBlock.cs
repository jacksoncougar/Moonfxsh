...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScenarioClusterWeatherPropertiesBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScenarioClusterWeatherPropertiesBlockBase
    {
        ...
        internal  ScenarioClusterWeatherPropertiesBlockBase(System.IO.BinaryReader binaryReader)
        {
