...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScenarioControlBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScenarioControlBlockBase
    {
        ...
        internal  ScenarioControlBlockBase(System.IO.BinaryReader binaryReader)
        {
