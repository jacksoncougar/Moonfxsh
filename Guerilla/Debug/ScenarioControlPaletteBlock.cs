...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScenarioControlPaletteBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScenarioControlPaletteBlockBase
    {
        ...
        internal  ScenarioControlPaletteBlockBase(System.IO.BinaryReader binaryReader)
        {
