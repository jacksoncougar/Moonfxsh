...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScenarioCratePaletteBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScenarioCratePaletteBlockBase
    {
        ...
        internal  ScenarioCratePaletteBlockBase(System.IO.BinaryReader binaryReader)
        {
