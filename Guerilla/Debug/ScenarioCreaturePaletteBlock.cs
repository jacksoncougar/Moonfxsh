...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScenarioCreaturePaletteBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScenarioCreaturePaletteBlockBase
    {
        ...
        internal  ScenarioCreaturePaletteBlockBase(System.IO.BinaryReader binaryReader)
        {
