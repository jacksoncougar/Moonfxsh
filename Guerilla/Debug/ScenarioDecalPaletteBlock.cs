...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScenarioDecalPaletteBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScenarioDecalPaletteBlockBase
    {
        ...
        internal  ScenarioDecalPaletteBlockBase(System.IO.BinaryReader binaryReader)
        {
