...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScenarioDecoratorSetPaletteEntryBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScenarioDecoratorSetPaletteEntryBlockBase
    {
        ...
        internal  ScenarioDecoratorSetPaletteEntryBlockBase(System.IO.BinaryReader binaryReader)
        {
