...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScenarioDetailObjectCollectionPaletteBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScenarioDetailObjectCollectionPaletteBlockBase
    {
        ...
        internal  ScenarioDetailObjectCollectionPaletteBlockBase(System.IO.BinaryReader binaryReader)
        {
