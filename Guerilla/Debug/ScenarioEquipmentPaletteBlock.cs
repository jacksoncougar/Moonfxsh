...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScenarioEquipmentPaletteBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScenarioEquipmentPaletteBlockBase
    {
        ...
        internal  ScenarioEquipmentPaletteBlockBase(System.IO.BinaryReader binaryReader)
        {
