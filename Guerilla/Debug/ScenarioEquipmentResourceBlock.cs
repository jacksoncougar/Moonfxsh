...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScenarioEquipmentResourceBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScenarioEquipmentResourceBlockBase
    {
        ...
        internal  ScenarioEquipmentResourceBlockBase(System.IO.BinaryReader binaryReader)
        {
