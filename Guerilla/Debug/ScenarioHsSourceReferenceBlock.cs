...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScenarioHsSourceReferenceBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScenarioHsSourceReferenceBlockBase
    {
        ...
        internal  ScenarioHsSourceReferenceBlockBase(System.IO.BinaryReader binaryReader)
        {
