...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScenarioKillTriggerVolumesBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScenarioKillTriggerVolumesBlockBase
    {
        ...
        internal  ScenarioKillTriggerVolumesBlockBase(System.IO.BinaryReader binaryReader)
        {
