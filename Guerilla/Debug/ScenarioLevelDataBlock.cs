...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScenarioLevelDataBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScenarioLevelDataBlockBase
    {
        ...
        internal  ScenarioLevelDataBlockBase(System.IO.BinaryReader binaryReader)
        {
