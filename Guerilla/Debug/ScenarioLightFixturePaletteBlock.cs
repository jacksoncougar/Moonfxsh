...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScenarioLightFixturePaletteBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScenarioLightFixturePaletteBlockBase
    {
        ...
        internal  ScenarioLightFixturePaletteBlockBase(System.IO.BinaryReader binaryReader)
        {
