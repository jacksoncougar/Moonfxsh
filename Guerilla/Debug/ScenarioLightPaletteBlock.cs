...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScenarioLightPaletteBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScenarioLightPaletteBlockBase
    {
        ...
        internal  ScenarioLightPaletteBlockBase(System.IO.BinaryReader binaryReader)
        {
