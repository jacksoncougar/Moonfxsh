...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScenarioNetgameEquipmentBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScenarioNetgameEquipmentBlockBase
    {
        ...
        internal  ScenarioNetgameEquipmentBlockBase(System.IO.BinaryReader binaryReader)
        {
