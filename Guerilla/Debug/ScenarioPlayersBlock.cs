...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScenarioPlayersBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScenarioPlayersBlockBase
    {
        ...
        internal  ScenarioPlayersBlockBase(System.IO.BinaryReader binaryReader)
        {
