...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScenarioProfilesBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScenarioProfilesBlockBase
    {
        ...
        internal  ScenarioProfilesBlockBase(System.IO.BinaryReader binaryReader)
        {
