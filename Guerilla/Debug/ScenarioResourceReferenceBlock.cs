...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScenarioResourceReferenceBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScenarioResourceReferenceBlockBase
    {
        ...
        internal  ScenarioResourceReferenceBlockBase(System.IO.BinaryReader binaryReader)
        {
