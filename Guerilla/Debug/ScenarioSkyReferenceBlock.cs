...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScenarioSkyReferenceBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScenarioSkyReferenceBlockBase
    {
        ...
        internal  ScenarioSkyReferenceBlockBase(System.IO.BinaryReader binaryReader)
        {
