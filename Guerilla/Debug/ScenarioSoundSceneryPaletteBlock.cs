...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScenarioSoundSceneryPaletteBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScenarioSoundSceneryPaletteBlockBase
    {
        ...
        internal  ScenarioSoundSceneryPaletteBlockBase(System.IO.BinaryReader binaryReader)
        {
