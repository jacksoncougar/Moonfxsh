...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ScenarioWeaponPaletteBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ScenarioWeaponPaletteBlockBase
    {
        ...
        internal  ScenarioWeaponPaletteBlockBase(System.IO.BinaryReader binaryReader)
        {
