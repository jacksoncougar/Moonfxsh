...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ShaderPassParameterBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ShaderPassParameterBlockBase
    {
        ...
        internal  ShaderPassParameterBlockBase(System.IO.BinaryReader binaryReader)
        {
