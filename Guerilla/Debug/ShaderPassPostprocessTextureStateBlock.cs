...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ShaderPassPostprocessTextureStateBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ShaderPassPostprocessTextureStateBlockBase
    {
        ...
        internal  ShaderPassPostprocessTextureStateBlockBase(System.IO.BinaryReader binaryReader)
        {
