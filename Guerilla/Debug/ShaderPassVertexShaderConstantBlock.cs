...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ShaderPassVertexShaderConstantBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ShaderPassVertexShaderConstantBlockBase
    {
        ...
        internal  ShaderPassVertexShaderConstantBlockBase(System.IO.BinaryReader binaryReader)
        {
