...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ShaderPostprocessBitmapNewBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ShaderPostprocessBitmapNewBlockBase
    {
        ...
        internal  ShaderPostprocessBitmapNewBlockBase(System.IO.BinaryReader binaryReader)
        {
