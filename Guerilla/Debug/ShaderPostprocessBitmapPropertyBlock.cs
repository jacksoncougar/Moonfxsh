...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ShaderPostprocessBitmapPropertyBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
            
        }
    };
    [LayoutAttribute(Size = 4)]
    public class ShaderPostprocessBitmapPropertyBlockBase
    {
        internal short bitmapIndex;
        internal short animatedParameterIndex;
        internal  ShaderPostprocessBitmapPropertyBlockBase(System.IO.BinaryReader binaryReader)
        {
