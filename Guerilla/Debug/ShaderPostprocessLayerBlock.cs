...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ShaderPostprocessLayerBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ShaderPostprocessLayerBlockBase
    {
        ...
        internal  ShaderPostprocessLayerBlockBase(System.IO.BinaryReader binaryReader)
        {
