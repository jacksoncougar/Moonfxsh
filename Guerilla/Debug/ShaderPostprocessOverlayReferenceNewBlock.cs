...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ShaderPostprocessOverlayReferenceNewBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ShaderPostprocessOverlayReferenceNewBlockBase
    {
        ...
        internal  ShaderPostprocessOverlayReferenceNewBlockBase(System.IO.BinaryReader binaryReader)
        {
