...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ShaderPostprocessValueOverlayBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ShaderPostprocessValueOverlayBlockBase
    {
        ...
        internal  ShaderPostprocessValueOverlayBlockBase(System.IO.BinaryReader binaryReader)
        {
