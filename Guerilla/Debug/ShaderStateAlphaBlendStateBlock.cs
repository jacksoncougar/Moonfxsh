...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ShaderStateAlphaBlendStateBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ShaderStateAlphaBlendStateBlockBase
    {
        ...
        internal  ShaderStateAlphaBlendStateBlockBase(System.IO.BinaryReader binaryReader)
        {
