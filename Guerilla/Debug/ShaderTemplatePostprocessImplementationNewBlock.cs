...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ShaderTemplatePostprocessImplementationNewBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
            
        }
    };
    [LayoutAttribute(Size = 6)]
    public class ShaderTemplatePostprocessImplementationNewBlockBase
    {
        ...
        internal  ShaderTemplatePostprocessImplementationNewBlockBase(System.IO.BinaryReader binaryReader)
        {
