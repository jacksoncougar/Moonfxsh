...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ShaderTemplatePostprocessPassNewBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ShaderTemplatePostprocessPassNewBlockBase
    {
        ...
        internal  ShaderTemplatePostprocessPassNewBlockBase(System.IO.BinaryReader binaryReader)
        {
