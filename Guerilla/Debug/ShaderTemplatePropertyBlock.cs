...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ShaderTemplatePropertyBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ShaderTemplatePropertyBlockBase
    {
        ...
        internal  ShaderTemplatePropertyBlockBase(System.IO.BinaryReader binaryReader)
        {
