...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  ShaderTemplateRuntimeExternalLightResponseIndexBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class ShaderTemplateRuntimeExternalLightResponseIndexBlockBase
    {
        ...
        internal  ShaderTemplateRuntimeExternalLightResponseIndexBlockBase(System.IO.BinaryReader binaryReader)
        {
