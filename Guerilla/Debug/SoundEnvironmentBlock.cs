...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  SoundEnvironmentBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class SoundEnvironmentBlockBase
    {
        ...
        internal  SoundEnvironmentBlockBase(System.IO.BinaryReader binaryReader)
        {
