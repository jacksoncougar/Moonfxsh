...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  SoundGestaltImportNamesBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class SoundGestaltImportNamesBlockBase
    {
        ...
        internal  SoundGestaltImportNamesBlockBase(System.IO.BinaryReader binaryReader)
        {
