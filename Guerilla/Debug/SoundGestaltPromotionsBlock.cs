...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  SoundGestaltPromotionsBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class SoundGestaltPromotionsBlockBase
    {
        ...
        internal  SoundGestaltPromotionsBlockBase(System.IO.BinaryReader binaryReader)
        {
