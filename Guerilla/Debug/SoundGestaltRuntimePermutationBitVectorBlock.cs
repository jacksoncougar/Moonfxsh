...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  SoundGestaltRuntimePermutationBitVectorBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class SoundGestaltRuntimePermutationBitVectorBlockBase
    {
        ...
        internal  SoundGestaltRuntimePermutationBitVectorBlockBase(System.IO.BinaryReader binaryReader)
        {
