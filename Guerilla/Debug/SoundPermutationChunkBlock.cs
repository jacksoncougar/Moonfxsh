...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  SoundPermutationChunkBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class SoundPermutationChunkBlockBase
    {
        ...
        internal  SoundPermutationChunkBlockBase(System.IO.BinaryReader binaryReader)
        {
