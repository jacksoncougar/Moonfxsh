...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  SoundPlaybackParametersStructBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class SoundPlaybackParametersStructBlockBase
    {
        ...
        internal  SoundPlaybackParametersStructBlockBase(System.IO.BinaryReader binaryReader)
        {
