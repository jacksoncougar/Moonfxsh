...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  SpecialMovementBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class SpecialMovementBlockBase
    {
        ...
        internal  SpecialMovementBlockBase(System.IO.BinaryReader binaryReader)
        {
