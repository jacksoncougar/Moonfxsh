...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  StructureBspClusterDataBlockNew(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class StructureBspClusterDataBlockNewBase
    {
        ...
        internal  StructureBspClusterDataBlockNewBase(System.IO.BinaryReader binaryReader)
        {
