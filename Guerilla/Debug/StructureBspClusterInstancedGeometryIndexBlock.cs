...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  StructureBspClusterInstancedGeometryIndexBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class StructureBspClusterInstancedGeometryIndexBlockBase
    {
        ...
        internal  StructureBspClusterInstancedGeometryIndexBlockBase(System.IO.BinaryReader binaryReader)
        {
