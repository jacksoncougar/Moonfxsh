...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  StructureBspClusterPortalVertexBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class StructureBspClusterPortalVertexBlockBase
    {
        ...
        internal  StructureBspClusterPortalVertexBlockBase(System.IO.BinaryReader binaryReader)
        {
