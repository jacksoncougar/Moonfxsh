...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  StructureBspSkyOwnerClusterBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class StructureBspSkyOwnerClusterBlockBase
    {
        ...
        internal  StructureBspSkyOwnerClusterBlockBase(System.IO.BinaryReader binaryReader)
        {
