...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  StructureSoundClusterInteriorClusterIndices(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class StructureSoundClusterInteriorClusterIndicesBase
    {
        ...
        internal  StructureSoundClusterInteriorClusterIndicesBase(System.IO.BinaryReader binaryReader)
        {
