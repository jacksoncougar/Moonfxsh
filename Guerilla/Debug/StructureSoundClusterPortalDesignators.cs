...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  StructureSoundClusterPortalDesignators(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class StructureSoundClusterPortalDesignatorsBase
    {
        ...
        internal  StructureSoundClusterPortalDesignatorsBase(System.IO.BinaryReader binaryReader)
        {
