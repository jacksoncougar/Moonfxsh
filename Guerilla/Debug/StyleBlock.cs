...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  StyleBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class StyleBlockBase
    {
        ...
        internal  StyleBlockBase(System.IO.BinaryReader binaryReader)
        {
            ...
            ReadBehaviorNamesBlockArray(binaryReader);
        }
        ...
        internal  virtual BehaviorNamesBlock[] ReadBehaviorNamesBlockArray(System.IO.BinaryReader binaryReader)
        {
        ...
        internal  virtual void WriteBehaviorNamesBlockArray(System.IO.BinaryWriter binaryWriter)
        {
        ...
        public void Write(System.IO.BinaryWriter binaryWriter)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                WriteBehaviorNamesBlockArray(binaryWriter);
            }
        }
