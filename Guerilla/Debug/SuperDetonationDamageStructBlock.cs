...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  SuperDetonationDamageStructBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class SuperDetonationDamageStructBlockBase
    {
        ...
        internal  SuperDetonationDamageStructBlockBase(System.IO.BinaryReader binaryReader)
        {
