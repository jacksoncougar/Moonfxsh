...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  TableViewListReferenceBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
            
        }
    };
    [LayoutAttribute(Size = 40)]
    public class TableViewListReferenceBlockBase
    {
        ...
        internal  TableViewListReferenceBlockBase(System.IO.BinaryReader binaryReader)
        {
            ...
            ReadTableViewListRowReferenceBlockArray(binaryReader);
        }
        ...
        internal  virtual TableViewListRowReferenceBlock[] ReadTableViewListRowReferenceBlockArray(System.IO.BinaryReader binaryReader)
        {
            var elementSize = Deserializer.SizeOf(typeof(TableViewListRowReferenceBlock));
            var blamPointer = binaryReader.ReadBlamPointer(elementSize);
            var array = new TableViewListRowReferenceBlock[blamPointer.Count];
            using (binaryReader.BaseStream.Pin())
            {
                for (int i = 0; i < blamPointer.Count; ++i)
                {
                    binaryReader.BaseStream.Position = blamPointer[i];
                    array[i] = new TableViewListRowReferenceBlock(binaryReader);
                }
            }
            return array;
        }
        ...
        internal  virtual void WriteTableViewListRowReferenceBlockArray(System.IO.BinaryWriter binaryWriter)
        {
        ...
        public void Write(System.IO.BinaryWriter binaryWriter)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                WriteTableViewListRowReferenceBlockArray(binaryWriter);
            }
        }
        [FlagsAttribute]
