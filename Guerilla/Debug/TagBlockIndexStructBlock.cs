...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  TagBlockIndexStructBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class TagBlockIndexStructBlockBase
    {
        ...
        internal  TagBlockIndexStructBlockBase(System.IO.BinaryReader binaryReader)
        {
