...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  TextValuePairDefinitionBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class TextValuePairDefinitionBlockBase
    {
        ...
        internal  TextValuePairDefinitionBlockBase(System.IO.BinaryReader binaryReader)
        {
            ...
            ReadTextValuePairReferenceBlockArray(binaryReader);
        }
        ...
        internal  virtual TextValuePairReferenceBlock[] ReadTextValuePairReferenceBlockArray(System.IO.BinaryReader binaryReader)
        {
            var elementSize = Deserializer.SizeOf(typeof(TextValuePairReferenceBlock));
            var blamPointer = binaryReader.ReadBlamPointer(elementSize);
            var array = new TextValuePairReferenceBlock[blamPointer.Count];
            using (binaryReader.BaseStream.Pin())
            {
        ...
        internal  virtual void WriteTextValuePairReferenceBlockArray(System.IO.BinaryWriter binaryWriter)
        {
        ...
        public void Write(System.IO.BinaryWriter binaryWriter)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                WriteTextValuePairReferenceBlockArray(binaryWriter);
            }
        }
