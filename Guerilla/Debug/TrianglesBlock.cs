...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  TrianglesBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
            
        }
    };
    [LayoutAttribute(Size = 96)]
    public class TrianglesBlockBase
    {
        ...
        internal  TrianglesBlockBase(System.IO.BinaryReader binaryReader)
        {
