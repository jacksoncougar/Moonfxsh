...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  UiErrorBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
            
        }
    };
    [LayoutAttribute(Size = 24)]
    public class UiErrorBlockBase
    {
        ...
        internal  UiErrorBlockBase(System.IO.BinaryReader binaryReader)
        {
