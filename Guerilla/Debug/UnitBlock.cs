...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  UnitBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class UnitBlockBase : ObjectBlock
    {
        ...
        internal  UnitBlockBase(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
            ...
            ReadUnitPosturesBlockArray(binaryReader);
            ReadUnitHudReferenceBlockArray(binaryReader);
            ReadDialogueVariantBlockArray(binaryReader);
            ...
            ReadPoweredSeatBlockArray(binaryReader);
            ReadUnitWeaponBlockArray(binaryReader);
            ReadUnitSeatBlockArray(binaryReader);
        ...
        internal  virtual UnitPosturesBlock[] ReadUnitPosturesBlockArray(System.IO.BinaryReader binaryReader)
        {
        ...
        internal  virtual DialogueVariantBlock[] ReadDialogueVariantBlockArray(System.IO.BinaryReader binaryReader)
        {
        ...
        internal  virtual PoweredSeatBlock[] ReadPoweredSeatBlockArray(System.IO.BinaryReader binaryReader)
        {
        ...
        internal  virtual UnitWeaponBlock[] ReadUnitWeaponBlockArray(System.IO.BinaryReader binaryReader)
        {
        ...
        internal  virtual UnitSeatBlock[] ReadUnitSeatBlockArray(System.IO.BinaryReader binaryReader)
        {
        ...
        internal  virtual void WriteUnitPosturesBlockArray(System.IO.BinaryWriter binaryWriter)
        {
        ...
        internal  virtual void WriteDialogueVariantBlockArray(System.IO.BinaryWriter binaryWriter)
        {
            
        }
        internal  virtual void WritePoweredSeatBlockArray(System.IO.BinaryWriter binaryWriter)
        {
            
        }
        internal  virtual void WriteUnitWeaponBlockArray(System.IO.BinaryWriter binaryWriter)
        {
            
        }
        internal  virtual void WriteUnitSeatBlockArray(System.IO.BinaryWriter binaryWriter)
        {
        ...
        public void Write(System.IO.BinaryWriter binaryWriter)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                WriteUnitPosturesBlockArray(binaryWriter);
                WriteUnitHudReferenceBlockArray(binaryWriter);
                WriteDialogueVariantBlockArray(binaryWriter);
                binaryWriter.Write(grenadeVelocityWorldUnitsPerSecond);
                binaryWriter.Write((Int16)grenadeType);
                binaryWriter.Write(grenadeCount);
                WritePoweredSeatBlockArray(binaryWriter);
                WriteUnitWeaponBlockArray(binaryWriter);
                WriteUnitSeatBlockArray(binaryWriter);
