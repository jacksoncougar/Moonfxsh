...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  UnitCameraTrackBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class UnitCameraTrackBlockBase
    {
        ...
        internal  UnitCameraTrackBlockBase(System.IO.BinaryReader binaryReader)
        {
