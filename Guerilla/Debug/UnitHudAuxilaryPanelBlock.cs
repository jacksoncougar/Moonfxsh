...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  UnitHudAuxilaryPanelBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class UnitHudAuxilaryPanelBlockBase
    {
        ...
        internal  UnitHudAuxilaryPanelBlockBase(System.IO.BinaryReader binaryReader)
        {
