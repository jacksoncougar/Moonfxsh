...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  UnitHudInterfaceBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class UnitHudInterfaceBlockBase
    {
        ...
        internal  UnitHudInterfaceBlockBase(System.IO.BinaryReader binaryReader)
        {
            ...
            overchargeMinimumColor = binaryReader.ReadRGBColor();
            overchargeMaximumColor = binaryReader.ReadRGBColor();
            overchargeFlashColor = binaryReader.ReadRGBColor();
            overchargeEmptyColor = binaryReader.ReadRGBColor();
            ...
            colorAtMeterMinimum0 = binaryReader.ReadRGBColor();
            colorAtMeterMaximum0 = binaryReader.ReadRGBColor();
            flashColor0 = binaryReader.ReadRGBColor();
            ...
            mediumHealthLeftColor = binaryReader.ReadRGBColor();
            ...
            ReadUnitHudAuxilaryOverlayBlockArray(binaryReader);
            invalidName_39 = binaryReader.ReadBytes(16);
            ReadUnitHudSoundBlockArray(binaryReader);
            ReadUnitHudAuxilaryPanelBlockArray(binaryReader);
        ...
        internal  virtual UnitHudAuxilaryOverlayBlock[] ReadUnitHudAuxilaryOverlayBlockArray(System.IO.BinaryReader binaryReader)
        {
        ...
        internal  virtual UnitHudSoundBlock[] ReadUnitHudSoundBlockArray(System.IO.BinaryReader binaryReader)
        {
        ...
        internal  virtual UnitHudAuxilaryPanelBlock[] ReadUnitHudAuxilaryPanelBlockArray(System.IO.BinaryReader binaryReader)
        {
        ...
        internal  virtual void WriteUnitHudAuxilaryOverlayBlockArray(System.IO.BinaryWriter binaryWriter)
        {
            
        }
        internal  virtual void WriteUnitHudSoundBlockArray(System.IO.BinaryWriter binaryWriter)
        {
            
        }
        internal  virtual void WriteUnitHudAuxilaryPanelBlockArray(System.IO.BinaryWriter binaryWriter)
        {
        ...
        public void Write(System.IO.BinaryWriter binaryWriter)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                WriteUnitHudAuxilaryOverlayBlockArray(binaryWriter);
                binaryWriter.Write(invalidName_39, 0, 16);
                WriteUnitHudSoundBlockArray(binaryWriter);
                WriteUnitHudAuxilaryPanelBlockArray(binaryWriter);
