...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  UnitHudReferenceBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class UnitHudReferenceBlockBase
    {
        ...
        internal  UnitHudReferenceBlockBase(System.IO.BinaryReader binaryReader)
        {
