...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  UnitLipsyncScalesStructBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class UnitLipsyncScalesStructBlockBase
    {
        ...
        internal  UnitLipsyncScalesStructBlockBase(System.IO.BinaryReader binaryReader)
        {
