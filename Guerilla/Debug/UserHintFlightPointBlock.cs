...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  UserHintFlightPointBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class UserHintFlightPointBlockBase
    {
        ...
        internal  UserHintFlightPointBlockBase(System.IO.BinaryReader binaryReader)
        {
