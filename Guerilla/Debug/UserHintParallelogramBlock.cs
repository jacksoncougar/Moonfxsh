...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  UserHintParallelogramBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class UserHintParallelogramBlockBase
    {
        ...
        internal  UserHintParallelogramBlockBase(System.IO.BinaryReader binaryReader)
        {
