...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  UserInterfaceScreenWidgetDefinitionBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
            
        }
    };
    [LayoutAttribute(Size = 112)]
    public class UserInterfaceScreenWidgetDefinitionBlockBase
    {
        ...
        internal  UserInterfaceScreenWidgetDefinitionBlockBase(System.IO.BinaryReader binaryReader)
        {
            ...
            ReadWindowPaneReferenceBlockArray(binaryReader);
            shapeGroup = (ShapeGroup)binaryReader.ReadInt16();
            invalidName_ = binaryReader.ReadBytes(2);
            headerStringId = binaryReader.ReadStringID();
            ReadLocalStringIdListSectionReferenceBlockArray(binaryReader);
            ReadLocalBitmapReferenceBlockArray(binaryReader);
        ...
        internal  virtual WindowPaneReferenceBlock[] ReadWindowPaneReferenceBlockArray(System.IO.BinaryReader binaryReader)
        {
            var elementSize = Deserializer.SizeOf(typeof(WindowPaneReferenceBlock));
            var blamPointer = binaryReader.ReadBlamPointer(elementSize);
            var array = new WindowPaneReferenceBlock[blamPointer.Count];
            using (binaryReader.BaseStream.Pin())
            {
                for (int i = 0; i < blamPointer.Count; ++i)
                {
                    binaryReader.BaseStream.Position = blamPointer[i];
                    array[i] = new WindowPaneReferenceBlock(binaryReader);
                }
            }
            return array;
        }
        internal  virtual LocalStringIdListSectionReferenceBlock[] ReadLocalStringIdListSectionReferenceBlockArray(System.IO.BinaryReader binaryReader)
        {
            var elementSize = Deserializer.SizeOf(typeof(LocalStringIdListSectionReferenceBlock));
            var blamPointer = binaryReader.ReadBlamPointer(elementSize);
            var array = new LocalStringIdListSectionReferenceBlock[blamPointer.Count];
            using (binaryReader.BaseStream.Pin())
            {
                for (int i = 0; i < blamPointer.Count; ++i)
                {
                    binaryReader.BaseStream.Position = blamPointer[i];
                    array[i] = new LocalStringIdListSectionReferenceBlock(binaryReader);
                }
            }
            return array;
        }
        internal  virtual LocalBitmapReferenceBlock[] ReadLocalBitmapReferenceBlockArray(System.IO.BinaryReader binaryReader)
        {
            var elementSize = Deserializer.SizeOf(typeof(LocalBitmapReferenceBlock));
            var blamPointer = binaryReader.ReadBlamPointer(elementSize);
            var array = new LocalBitmapReferenceBlock[blamPointer.Count];
            using (binaryReader.BaseStream.Pin())
            {
                for (int i = 0; i < blamPointer.Count; ++i)
                {
                    binaryReader.BaseStream.Position = blamPointer[i];
                    array[i] = new LocalBitmapReferenceBlock(binaryReader);
                }
            }
            return array;
        }
        ...
        internal  virtual void WriteWindowPaneReferenceBlockArray(System.IO.BinaryWriter binaryWriter)
        {
            
        }
        internal  virtual void WriteLocalStringIdListSectionReferenceBlockArray(System.IO.BinaryWriter binaryWriter)
        {
            
        }
        internal  virtual void WriteLocalBitmapReferenceBlockArray(System.IO.BinaryWriter binaryWriter)
        {
        ...
        public void Write(System.IO.BinaryWriter binaryWriter)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                WriteWindowPaneReferenceBlockArray(binaryWriter);
                binaryWriter.Write((Int16)shapeGroup);
                binaryWriter.Write(invalidName_, 0, 2);
                binaryWriter.Write(headerStringId);
                WriteLocalStringIdListSectionReferenceBlockArray(binaryWriter);
                WriteLocalBitmapReferenceBlockArray(binaryWriter);
