...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  VehicleBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class VehicleBlockBase : UnitBlock
    {
        ...
        internal  VehicleBlockBase(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
            ...
            ReadGearBlockArray(binaryReader);
        ...
        internal  virtual GearBlock[] ReadGearBlockArray(System.IO.BinaryReader binaryReader)
        {
        ...
        internal  virtual void WriteGearBlockArray(System.IO.BinaryWriter binaryWriter)
        {
        ...
        public void Write(System.IO.BinaryWriter binaryWriter)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                WriteGearBlockArray(binaryWriter);
