...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  VehiclePhantomShapeBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class VehiclePhantomShapeBlockBase
    {
        ...
        internal  VehiclePhantomShapeBlockBase(System.IO.BinaryReader binaryReader)
        {
        ...
        public class Multispheres
        {
            ...
            internal  Multispheres(System.IO.BinaryReader binaryReader)
            {
                invalidName_ = binaryReader.ReadBytes(4);
                size = binaryReader.ReadInt16();
                count = binaryReader.ReadInt16();
