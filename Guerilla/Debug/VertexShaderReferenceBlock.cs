...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  VertexShaderReferenceBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class VertexShaderReferenceBlockBase
    {
        ...
        internal  VertexShaderReferenceBlockBase(System.IO.BinaryReader binaryReader)
        {
