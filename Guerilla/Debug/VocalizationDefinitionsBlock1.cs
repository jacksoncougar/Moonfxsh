...
{
    public  partial class VocalizationDefinitionsBlock1 : VocalizationDefinitionsBlock1Base
    {
        public  VocalizationDefinitionsBlock1(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
            
        }
    };
    [LayoutAttribute(Size = 96)]
    public class VocalizationDefinitionsBlock1Base
    {
        ...
        internal VocalizationDefinitionsBlock2[] children;
        internal  VocalizationDefinitionsBlock1Base(System.IO.BinaryReader binaryReader)
        {
            ...
            ReadVocalizationDefinitionsBlock2Array(binaryReader);
        }
        ...
        internal  virtual VocalizationDefinitionsBlock2[] ReadVocalizationDefinitionsBlock2Array(System.IO.BinaryReader binaryReader)
        {
            var elementSize = Deserializer.SizeOf(typeof(VocalizationDefinitionsBlock2));
            var blamPointer = binaryReader.ReadBlamPointer(elementSize);
            var array = new VocalizationDefinitionsBlock2[blamPointer.Count];
            using (binaryReader.BaseStream.Pin())
            {
                for (int i = 0; i < blamPointer.Count; ++i)
                {
                    binaryReader.BaseStream.Position = blamPointer[i];
                    array[i] = new VocalizationDefinitionsBlock2(binaryReader);
                }
            }
            return array;
        }
        ...
        internal  virtual void WriteVocalizationDefinitionsBlock2Array(System.IO.BinaryWriter binaryWriter)
        {
        ...
        public void Write(System.IO.BinaryWriter binaryWriter)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                WriteVocalizationDefinitionsBlock2Array(binaryWriter);
            }
        }
