...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  VocalizationDefinitionsBlock2(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
            
        }
    };
    [LayoutAttribute(Size = 96)]
    public class VocalizationDefinitionsBlock2Base
    {
        ...
        internal  VocalizationDefinitionsBlock2Base(System.IO.BinaryReader binaryReader)
        {
            ...
            ReadVocalizationDefinitionsBlock3Array(binaryReader);
        }
        ...
        internal  virtual VocalizationDefinitionsBlock3[] ReadVocalizationDefinitionsBlock3Array(System.IO.BinaryReader binaryReader)
        {
            var elementSize = Deserializer.SizeOf(typeof(VocalizationDefinitionsBlock3));
            var blamPointer = binaryReader.ReadBlamPointer(elementSize);
            var array = new VocalizationDefinitionsBlock3[blamPointer.Count];
            using (binaryReader.BaseStream.Pin())
            {
                for (int i = 0; i < blamPointer.Count; ++i)
                {
                    binaryReader.BaseStream.Position = blamPointer[i];
                    array[i] = new VocalizationDefinitionsBlock3(binaryReader);
                }
            }
            return array;
        }
        ...
        internal  virtual void WriteVocalizationDefinitionsBlock3Array(System.IO.BinaryWriter binaryWriter)
        {
        ...
        public void Write(System.IO.BinaryWriter binaryWriter)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                WriteVocalizationDefinitionsBlock3Array(binaryWriter);
            }
        }
