...
{
    public  partial class VocalizationDefinitionsBlock3 : VocalizationDefinitionsBlock3Base
    {
        public  VocalizationDefinitionsBlock3(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class VocalizationDefinitionsBlock3Base
    {
        ...
        internal  VocalizationDefinitionsBlock3Base(System.IO.BinaryReader binaryReader)
        {
            ...
            ReadVocalizationDefinitionsBlock4Array(binaryReader);
        }
        ...
        internal  virtual VocalizationDefinitionsBlock4[] ReadVocalizationDefinitionsBlock4Array(System.IO.BinaryReader binaryReader)
        {
            var elementSize = Deserializer.SizeOf(typeof(VocalizationDefinitionsBlock4));
            var blamPointer = binaryReader.ReadBlamPointer(elementSize);
            var array = new VocalizationDefinitionsBlock4[blamPointer.Count];
            using (binaryReader.BaseStream.Pin())
            {
                for (int i = 0; i < blamPointer.Count; ++i)
                {
        ...
        internal  virtual void WriteVocalizationDefinitionsBlock4Array(System.IO.BinaryWriter binaryWriter)
        {
        ...
        public void Write(System.IO.BinaryWriter binaryWriter)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                WriteVocalizationDefinitionsBlock4Array(binaryWriter);
            }
        }
