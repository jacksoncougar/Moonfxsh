...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  VocalizationDefinitionsBlock4(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
            
        }
    };
    [LayoutAttribute(Size = 96)]
    public class VocalizationDefinitionsBlock4Base
    {
        ...
        internal  VocalizationDefinitionsBlock4Base(System.IO.BinaryReader binaryReader)
        {
            ...
            ReadVocalizationDefinitionsBlock5Array(binaryReader);
        }
        ...
        internal  virtual VocalizationDefinitionsBlock5[] ReadVocalizationDefinitionsBlock5Array(System.IO.BinaryReader binaryReader)
        {
            var elementSize = Deserializer.SizeOf(typeof(VocalizationDefinitionsBlock5));
            var blamPointer = binaryReader.ReadBlamPointer(elementSize);
            var array = new VocalizationDefinitionsBlock5[blamPointer.Count];
            using (binaryReader.BaseStream.Pin())
            {
                for (int i = 0; i < blamPointer.Count; ++i)
                {
                    binaryReader.BaseStream.Position = blamPointer[i];
                    array[i] = new VocalizationDefinitionsBlock5(binaryReader);
                }
            }
            return array;
        }
        ...
        internal  virtual void WriteVocalizationDefinitionsBlock5Array(System.IO.BinaryWriter binaryWriter)
        {
        ...
        public void Write(System.IO.BinaryWriter binaryWriter)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                WriteVocalizationDefinitionsBlock5Array(binaryWriter);
            }
        }
