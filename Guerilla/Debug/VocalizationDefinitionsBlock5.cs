...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  VocalizationDefinitionsBlock5(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
            
        }
    };
    [LayoutAttribute(Size = 96)]
    public class VocalizationDefinitionsBlock5Base
    {
        ...
        internal  VocalizationDefinitionsBlock5Base(System.IO.BinaryReader binaryReader)
        {
