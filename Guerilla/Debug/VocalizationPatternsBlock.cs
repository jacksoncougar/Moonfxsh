...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  VocalizationPatternsBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class VocalizationPatternsBlockBase
    {
        ...
        internal  VocalizationPatternsBlockBase(System.IO.BinaryReader binaryReader)
        {
