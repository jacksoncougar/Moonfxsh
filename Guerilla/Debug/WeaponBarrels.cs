...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  WeaponBarrels(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class WeaponBarrelsBase
    {
        ...
        internal  WeaponBarrelsBase(System.IO.BinaryReader binaryReader)
        {
            ...
            ReadBarrelFiringEffectBlockArray(binaryReader);
        }
        ...
        internal  virtual BarrelFiringEffectBlock[] ReadBarrelFiringEffectBlockArray(System.IO.BinaryReader binaryReader)
        {
        ...
        internal  virtual void WriteBarrelFiringEffectBlockArray(System.IO.BinaryWriter binaryWriter)
        {
        ...
        public void Write(System.IO.BinaryWriter binaryWriter)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                WriteBarrelFiringEffectBlockArray(binaryWriter);
            }
        }
        [FlagsAttribute]
