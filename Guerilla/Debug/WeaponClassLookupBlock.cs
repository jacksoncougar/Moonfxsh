...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  WeaponClassLookupBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class WeaponClassLookupBlockBase
    {
        ...
        internal  WeaponClassLookupBlockBase(System.IO.BinaryReader binaryReader)
        {
