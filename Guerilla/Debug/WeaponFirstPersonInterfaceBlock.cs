...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  WeaponFirstPersonInterfaceBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class WeaponFirstPersonInterfaceBlockBase
    {
        ...
        internal  WeaponFirstPersonInterfaceBlockBase(System.IO.BinaryReader binaryReader)
        {
