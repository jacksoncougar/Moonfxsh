...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  WeaponHudCrosshairItemBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class WeaponHudCrosshairItemBlockBase
    {
        ...
        internal  WeaponHudCrosshairItemBlockBase(System.IO.BinaryReader binaryReader)
        {
