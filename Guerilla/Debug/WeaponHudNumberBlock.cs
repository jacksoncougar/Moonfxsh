...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  WeaponHudNumberBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class WeaponHudNumberBlockBase
    {
        ...
        internal  WeaponHudNumberBlockBase(System.IO.BinaryReader binaryReader)
        {
