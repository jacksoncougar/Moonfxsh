...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  WeaponHudOverlayBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class WeaponHudOverlayBlockBase
    {
        ...
        internal  WeaponHudOverlayBlockBase(System.IO.BinaryReader binaryReader)
        {
