...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  WindowPaneReferenceBlock(System.IO.BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class WindowPaneReferenceBlockBase
    {
        ...
        internal  WindowPaneReferenceBlockBase(System.IO.BinaryReader binaryReader)
        {
            invalidName_ = binaryReader.ReadBytes(2);
            animationIndex = (AnimationIndex)binaryReader.ReadInt16();
            ReadButtonWidgetReferenceBlockArray(binaryReader);
            ReadListReferenceBlockArray(binaryReader);
            ReadTableViewListReferenceBlockArray(binaryReader);
            ...
            ReadSTextValuePairBlocksBlockUNUSEDArray(binaryReader);
        ...
        internal  virtual ButtonWidgetReferenceBlock[] ReadButtonWidgetReferenceBlockArray(System.IO.BinaryReader binaryReader)
        {
        ...
        internal  virtual ListReferenceBlock[] ReadListReferenceBlockArray(System.IO.BinaryReader binaryReader)
        {
        ...
        internal  virtual TableViewListReferenceBlock[] ReadTableViewListReferenceBlockArray(System.IO.BinaryReader binaryReader)
        {
        ...
        internal  virtual STextValuePairBlocksBlockUNUSED[] ReadSTextValuePairBlocksBlockUNUSEDArray(System.IO.BinaryReader binaryReader)
        {
        ...
        internal  virtual void WriteButtonWidgetReferenceBlockArray(System.IO.BinaryWriter binaryWriter)
        {
            
        }
        internal  virtual void WriteListReferenceBlockArray(System.IO.BinaryWriter binaryWriter)
        {
            
        }
        internal  virtual void WriteTableViewListReferenceBlockArray(System.IO.BinaryWriter binaryWriter)
        {
        ...
        internal  virtual void WriteSTextValuePairBlocksBlockUNUSEDArray(System.IO.BinaryWriter binaryWriter)
        {
        ...
        public void Write(System.IO.BinaryWriter binaryWriter)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                WriteButtonWidgetReferenceBlockArray(binaryWriter);
                WriteListReferenceBlockArray(binaryWriter);
                WriteTableViewListReferenceBlockArray(binaryWriter);
                ...
                WriteSTextValuePairBlocksBlockUNUSEDArray(binaryWriter);
