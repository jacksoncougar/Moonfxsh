    ...
    public class CharacterBlockBase : IGuerilla
    {
        ...
        public int Write( System.IO.BinaryWriter binaryWriter, Int32 nextAddress )
        {
            using ( binaryWriter.BaseStream.Pin( ) )
            {
                ...
                nextAddress = Guerilla.WriteBlockArray<CharacterEngageBlock>( binaryWriter, engageProperties,
                    nextAddress );
                nextAddress = Guerilla.WriteBlockArray<CharacterChargeBlock>( binaryWriter, chargeProperties,
                    nextAddress );
                ...
                nextAddress = Guerilla.WriteBlockArray<CharacterRetreatBlock>( binaryWriter, retreatProperties,
                    nextAddress );
                nextAddress = Guerilla.WriteBlockArray<CharacterSearchBlock>( binaryWriter, searchProperties,
                    nextAddress );
