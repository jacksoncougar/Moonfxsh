...
namespace Moonfish.Tags
{
    ...
    {
        public static readonly TagClass Cont = (TagClass) "cont";
    };
} ;
...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class ContrailBlockBase : GuerillaBlock
    {
        ...
        [TagReference("bitm")] internal Moonfish.Tags.TagReference bitmap0;
        ...
        public override Queue<BlamPointer> ReadFields(BinaryReader binaryReader)
        {
            ...
            scaleFlags =
                (ScaleFlagsTheseFlagsDetermineWhichFieldsAreScaledByTheContrailDensity) binaryReader.ReadInt16();
            ...
            blamPointers.Enqueue(ReadBlockArrayPointer<ContrailPointStatesBlock>(binaryReader));
            return blamPointers;
        }
        ...
        public override void ReadPointers(BinaryReader binaryReader, Queue<BlamPointer> blamPointers)
        {
            ...
            pointStates = ReadBlockArrayData<ContrailPointStatesBlock>(binaryReader, blamPointers.Dequeue());
        }
