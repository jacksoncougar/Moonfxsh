...
namespace Moonfish.Tags
{
    ...
    {
        public static readonly TagClass Jpt = (TagClass)"jpt!";
    };
};
...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class DamageEffectBlockBase : GuerillaBlock
    {
        ...
        internal  DamageEffectBlockBase(BinaryReader binaryReader): base(binaryReader)
        {
        ...
        public override int Write(System.IO.BinaryWriter binaryWriter, Int32 nextAddress)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                nextAddress = Guerilla.WriteBlockArray<DamageEffectPlayerResponseBlock>(binaryWriter, playerResponses, nextAddress);
