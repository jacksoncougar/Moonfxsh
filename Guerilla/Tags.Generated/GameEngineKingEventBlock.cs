...
namespace Moonfish.Guerilla.Tags
{
    public partial class GameEngineKingEventBlock : GameEngineKingEventBlockBase
    {
        ...
        public  GameEngineKingEventBlock(): base()
        {
            
        }
    };
    [LayoutAttribute(Size = 168, Alignment = 4)]
    public class GameEngineKingEventBlockBase : GuerillaBlock
    {
        ...
        public  GameEngineKingEventBlockBase(BinaryReader binaryReader): base(binaryReader)
        {
        ...
        public  GameEngineKingEventBlockBase(): base()
        {
