...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  GameEngineOddballEventBlock(BinaryReader binaryReader): base(binaryReader)
        {
            
        }
        public  GameEngineOddballEventBlock(): base()
        {
            
        }
    };
    [LayoutAttribute(Size = 168, Alignment = 4)]
    public class GameEngineOddballEventBlockBase : GuerillaBlock
    {
        ...
        public  GameEngineOddballEventBlockBase(BinaryReader binaryReader): base(binaryReader)
        {
        ...
        public  GameEngineOddballEventBlockBase(): base()
        {
