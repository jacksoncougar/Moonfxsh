...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public GameEngineSlayerEventBlock( BinaryReader binaryReader ) : base( binaryReader )
        {
        }
    };

    [LayoutAttribute( Size = 168, Alignment = 4 )]
    public class GameEngineSlayerEventBlockBase : IGuerilla
    {
        ...
        internal GameEngineSlayerEventBlockBase( BinaryReader binaryReader )
        {
