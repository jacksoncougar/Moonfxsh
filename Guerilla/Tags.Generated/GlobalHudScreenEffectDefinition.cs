...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class GlobalHudScreenEffectDefinitionBase : IGuerilla
    {
        internal byte[] invalidName_;
        internal Flags flags;
        internal byte[] invalidName_0;
        internal byte[] invalidName_1;
        [TagReference( "bitm" )] internal Moonfish.Tags.TagReference maskFullscreen;
        [TagReference( "bitm" )] internal Moonfish.Tags.TagReference maskSplitscreen;
        ...
        [TagReference( "egor" )] internal Moonfish.Tags.TagReference screenEffect0;
