...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        [TagReference( "unic" )] internal Moonfish.Tags.TagReference hudText;
        ...
        public int Write( System.IO.BinaryWriter binaryWriter, Int32 nextAddress )
        {
            using ( binaryWriter.BaseStream.Pin( ) )
            {
                ...
                nextAddress = Guerilla.WriteBlockArray<PlayerTrainingEntryDataBlock>( binaryWriter, playerTrainingData,
                    nextAddress );
