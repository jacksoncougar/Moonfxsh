...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class HudWidgetEffectBlockBase : GuerillaBlock
    {
        ...
        public override Queue<BlamPointer> ReadFields(BinaryReader binaryReader)
        {
            ...
            blamPointers =
                new Queue<BlamPointer>(blamPointers.Concat(hudWidgetEffectFunctionStruct.ReadFields(binaryReader)));
            hudWidgetEffectFunctionStruct0 = new HudWidgetEffectFunctionStructBlock();
            blamPointers =
                new Queue<BlamPointer>(blamPointers.Concat(hudWidgetEffectFunctionStruct0.ReadFields(binaryReader)));
            hudWidgetEffectFunctionStruct1 = new HudWidgetEffectFunctionStructBlock();
            blamPointers =
                new Queue<BlamPointer>(blamPointers.Concat(hudWidgetEffectFunctionStruct1.ReadFields(binaryReader)));
            hudWidgetEffectFunctionStruct2 = new HudWidgetEffectFunctionStructBlock();
            blamPointers =
                new Queue<BlamPointer>(blamPointers.Concat(hudWidgetEffectFunctionStruct2.ReadFields(binaryReader)));
            hudWidgetEffectFunctionStruct3 = new HudWidgetEffectFunctionStructBlock();
            blamPointers =
                new Queue<BlamPointer>(blamPointers.Concat(hudWidgetEffectFunctionStruct3.ReadFields(binaryReader)));
            return blamPointers;
        }
