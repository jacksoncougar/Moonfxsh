...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class LightVolumeVolumeBlockBase : GuerillaBlock
    {
        ...
        public override Queue<BlamPointer> ReadFields(BinaryReader binaryReader)
        {
            ...
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(offsetFunction.ReadFields(binaryReader)));
            radiusFunction = new ScalarFunctionStructBlock();
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(radiusFunction.ReadFields(binaryReader)));
            brightnessFunction = new ScalarFunctionStructBlock();
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(brightnessFunction.ReadFields(binaryReader)));
            colorFunction = new ColorFunctionStructBlock();
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(colorFunction.ReadFields(binaryReader)));
            facingFunction = new ScalarFunctionStructBlock();
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(facingFunction.ReadFields(binaryReader)));
