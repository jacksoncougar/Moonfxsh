...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class LightmapVertexBufferBucketBlockBase : GuerillaBlock
    {
        ...
        public override void ReadPointers(BinaryReader binaryReader, Queue<BlamPointer> blamPointers)
        {
            ...
            cacheData = ReadBlockArrayData<LightmapVertexBufferBucketCacheDataBlock>(binaryReader,
        ...
        public override int Write(BinaryWriter binaryWriter, int nextAddress)
        {
            ...
            using (binaryWriter.BaseStream.Pin())
            {
                ...
                nextAddress = Guerilla.WriteBlockArray<LightmapBucketRawVertexBlock>(binaryWriter, rawVertices,
                    nextAddress);
                geometryBlockInfo.Write(binaryWriter);
                nextAddress = Guerilla.WriteBlockArray<LightmapVertexBufferBucketCacheDataBlock>(binaryWriter, cacheData,
                    nextAddress);
                return nextAddress;
            }
        }
