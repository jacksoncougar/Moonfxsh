...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class MultiplayerVariantSettingsInterfaceDefinitionBlockBase : IGuerilla
    {
        ...
        internal MultiplayerVariantSettingsInterfaceDefinitionBlockBase( BinaryReader binaryReader )
        {
            ...
            {
                new UnusedCreateNewVariants( binaryReader ), new UnusedCreateNewVariants( binaryReader ),
                new UnusedCreateNewVariants( binaryReader ), new UnusedCreateNewVariants( binaryReader ),
                new UnusedCreateNewVariants( binaryReader ), new UnusedCreateNewVariants( binaryReader ),
                new UnusedCreateNewVariants( binaryReader ),
            };
        }
        ...
        public int Write( System.IO.BinaryWriter binaryWriter, Int32 nextAddress )
        {
            using ( binaryWriter.BaseStream.Pin( ) )
            {
                ...
                nextAddress = Guerilla.WriteBlockArray<GDefaultVariantsBlock>( binaryWriter, defaultVariants,
                    nextAddress );
