...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class ParticleSystemEmitterDefinitionBlockBase : GuerillaBlock
    {
        ...
        public override Queue<BlamPointer> ReadFields(BinaryReader binaryReader)
        {
            ...
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(particleEmissionRate.ReadFields(binaryReader)));
            particleLifespan = new ParticlePropertyScalarStructNewBlock();
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(particleLifespan.ReadFields(binaryReader)));
            particleVelocity = new ParticlePropertyScalarStructNewBlock();
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(particleVelocity.ReadFields(binaryReader)));
            particleAngularVelocity = new ParticlePropertyScalarStructNewBlock();
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(particleAngularVelocity.ReadFields(binaryReader)));
            particleSize = new ParticlePropertyScalarStructNewBlock();
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(particleSize.ReadFields(binaryReader)));
            ...
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(emissionAngle.ReadFields(binaryReader)));
