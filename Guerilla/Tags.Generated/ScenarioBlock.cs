    ...
    public class ScenarioBlockBase : IGuerilla
    {
        ...
        internal ScenarioBlockBase( BinaryReader binaryReader )
        {
            ...
            detailObjectCollectionPalette =
                Guerilla.ReadBlockArray<ScenarioDetailObjectCollectionPaletteBlock>( binaryReader );
            ...
            objectSalts = new[]
            {
                new ObjectSalts( binaryReader ), new ObjectSalts( binaryReader ), new ObjectSalts( binaryReader ),
                new ObjectSalts( binaryReader ), new ObjectSalts( binaryReader ), new ObjectSalts( binaryReader ),
                new ObjectSalts( binaryReader ), new ObjectSalts( binaryReader ), new ObjectSalts( binaryReader ),
                new ObjectSalts( binaryReader ), new ObjectSalts( binaryReader ), new ObjectSalts( binaryReader ),
                new ObjectSalts( binaryReader ), new ObjectSalts( binaryReader ), new ObjectSalts( binaryReader ),
                ...
                new ObjectSalts( binaryReader ), new ObjectSalts( binaryReader ), new ObjectSalts( binaryReader ),
                new ObjectSalts( binaryReader ), new ObjectSalts( binaryReader ), new ObjectSalts( binaryReader ),
                new ObjectSalts( binaryReader ), new ObjectSalts( binaryReader ),
            };
