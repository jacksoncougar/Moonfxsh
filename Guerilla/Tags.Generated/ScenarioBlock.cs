...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class ScenarioBlockBase : GuerillaBlock
    {
        ...
        public override Queue<BlamPointer> ReadFields(BinaryReader binaryReader)
        {
            ...
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[3].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[4].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[5].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[6].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[7].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[8].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[9].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[10].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[11].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[12].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[13].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[14].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[15].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[16].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[17].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[18].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[19].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[20].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[21].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[22].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[23].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[24].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[25].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[26].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[27].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[28].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[29].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[30].ReadFields(binaryReader)));
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(objectSalts[31].ReadFields(binaryReader)));
        ...
        public override void ReadPointers(BinaryReader binaryReader, Queue<BlamPointer> blamPointers)
        {
            ...
            objectSalts[0].ReadPointers(binaryReader, blamPointers);
            objectSalts[1].ReadPointers(binaryReader, blamPointers);
            objectSalts[2].ReadPointers(binaryReader, blamPointers);
            objectSalts[3].ReadPointers(binaryReader, blamPointers);
            objectSalts[4].ReadPointers(binaryReader, blamPointers);
            objectSalts[5].ReadPointers(binaryReader, blamPointers);
            objectSalts[6].ReadPointers(binaryReader, blamPointers);
            objectSalts[7].ReadPointers(binaryReader, blamPointers);
            objectSalts[8].ReadPointers(binaryReader, blamPointers);
            objectSalts[9].ReadPointers(binaryReader, blamPointers);
            objectSalts[10].ReadPointers(binaryReader, blamPointers);
            objectSalts[11].ReadPointers(binaryReader, blamPointers);
            objectSalts[12].ReadPointers(binaryReader, blamPointers);
            objectSalts[13].ReadPointers(binaryReader, blamPointers);
            objectSalts[14].ReadPointers(binaryReader, blamPointers);
            objectSalts[15].ReadPointers(binaryReader, blamPointers);
            objectSalts[16].ReadPointers(binaryReader, blamPointers);
            objectSalts[17].ReadPointers(binaryReader, blamPointers);
            objectSalts[18].ReadPointers(binaryReader, blamPointers);
            objectSalts[19].ReadPointers(binaryReader, blamPointers);
            objectSalts[20].ReadPointers(binaryReader, blamPointers);
            objectSalts[21].ReadPointers(binaryReader, blamPointers);
            objectSalts[22].ReadPointers(binaryReader, blamPointers);
            objectSalts[23].ReadPointers(binaryReader, blamPointers);
            objectSalts[24].ReadPointers(binaryReader, blamPointers);
            objectSalts[25].ReadPointers(binaryReader, blamPointers);
            objectSalts[26].ReadPointers(binaryReader, blamPointers);
            objectSalts[27].ReadPointers(binaryReader, blamPointers);
            objectSalts[28].ReadPointers(binaryReader, blamPointers);
            objectSalts[29].ReadPointers(binaryReader, blamPointers);
            objectSalts[30].ReadPointers(binaryReader, blamPointers);
            objectSalts[31].ReadPointers(binaryReader, blamPointers);
