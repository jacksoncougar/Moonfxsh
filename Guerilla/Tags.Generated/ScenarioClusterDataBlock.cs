...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class ScenarioClusterDataBlockBase : GuerillaBlock
    {
        ...
        public override void ReadPointers(BinaryReader binaryReader, Queue<BlamPointer> blamPointers)
        {
            ...
            backgroundSounds = ReadBlockArrayData<ScenarioClusterBackgroundSoundsBlock>(binaryReader,
                blamPointers.Dequeue());
            soundEnvironments = ReadBlockArrayData<ScenarioClusterSoundEnvironmentsBlock>(binaryReader,
                blamPointers.Dequeue());
            clusterCentroids = ReadBlockArrayData<ScenarioClusterPointsBlock>(binaryReader, blamPointers.Dequeue());
            weatherProperties = ReadBlockArrayData<ScenarioClusterWeatherPropertiesBlock>(binaryReader,
                blamPointers.Dequeue());
            atmosphericFogProperties = ReadBlockArrayData<ScenarioClusterAtmosphericFogPropertiesBlock>(binaryReader,
                blamPointers.Dequeue());
        }
