...
namespace Moonfish.Guerilla.Tags
{
    public partial class ScenarioClusterSoundEnvironmentsBlock : ScenarioClusterSoundEnvironmentsBlockBase
    {
        ...
        public  ScenarioClusterSoundEnvironmentsBlock(): base()
        {
    ...
    public class ScenarioClusterSoundEnvironmentsBlockBase : GuerillaBlock
    {
        ...
        public  ScenarioClusterSoundEnvironmentsBlockBase(BinaryReader binaryReader): base(binaryReader)
        {
            type = binaryReader.ReadShortBlockIndex1();
            invalidName_ = binaryReader.ReadBytes(2);
        }
        public  ScenarioClusterSoundEnvironmentsBlockBase(): base()
        {
