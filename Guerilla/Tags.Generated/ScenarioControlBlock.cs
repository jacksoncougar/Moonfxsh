...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class ScenarioControlBlockBase : GuerillaBlock
    {
        ...
        public override Queue<BlamPointer> ReadFields(BinaryReader binaryReader)
        {
            ...
            controlData = new ScenarioControlStructBlock();
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(controlData.ReadFields(binaryReader)));
            return blamPointers;
        }
        public override void ReadPointers(BinaryReader binaryReader, Queue<BlamPointer> blamPointers)
        {
            ...
            controlData.ReadPointers(binaryReader, blamPointers);
        }
