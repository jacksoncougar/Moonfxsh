...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class ScenarioEquipmentBlockBase : GuerillaBlock
    {
        ...
        public override Queue<BlamPointer> ReadFields(BinaryReader binaryReader)
        {
            ...
            equipmentData = new ScenarioEquipmentDatumStructBlock();
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(equipmentData.ReadFields(binaryReader)));
            return blamPointers;
        }
        ...
        public override void ReadPointers(BinaryReader binaryReader, Queue<BlamPointer> blamPointers)
        {
            ...
            equipmentData.ReadPointers(binaryReader, blamPointers);
        }
