...
namespace Moonfish.Guerilla.Tags
{
    public partial class ScenarioEquipmentPaletteBlock : ScenarioEquipmentPaletteBlockBase
    {
        ...
        public  ScenarioEquipmentPaletteBlock(): base()
        {
            
        }
    };
    [LayoutAttribute(Size = 40, Alignment = 4)]
    public class ScenarioEquipmentPaletteBlockBase : GuerillaBlock
    {
        [TagReference("eqip")]
        ...
        public  ScenarioEquipmentPaletteBlockBase(BinaryReader binaryReader): base(binaryReader)
        {
            name = binaryReader.ReadTagReference();
            invalidName_ = binaryReader.ReadBytes(32);
        }
        public  ScenarioEquipmentPaletteBlockBase(): base()
        {
