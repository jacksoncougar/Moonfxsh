...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class ScenarioLightBlockBase : GuerillaBlock
    {
        ...
        public override Queue<BlamPointer> ReadFields(BinaryReader binaryReader)
        {
            ...
            lightData = new ScenarioLightStructBlock();
            blamPointers = new Queue<BlamPointer>(blamPointers.Concat(lightData.ReadFields(binaryReader)));
            return blamPointers;
        }
        ...
        public override void ReadPointers(BinaryReader binaryReader, Queue<BlamPointer> blamPointers)
        {
            ...
            lightData.ReadPointers(binaryReader, blamPointers);
        }
