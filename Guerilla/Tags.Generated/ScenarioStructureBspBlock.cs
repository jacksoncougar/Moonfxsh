...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class ScenarioStructureBspBlockBase : GuerillaBlock
    {
        ...
        [TagReference("DECP")] internal Moonfish.Tags.TagReference decorators;
        ...
        public override void ReadPointers(BinaryReader binaryReader, Queue<BlamPointer> blamPointers)
        {
            ...
            collisionMaterials = ReadBlockArrayData<StructureCollisionMaterialsBlock>(binaryReader,
            ...
            weatherPolyhedra = ReadBlockArrayData<StructureBspWeatherPolyhedronBlock>(binaryReader,
                blamPointers.Dequeue());
            ...
            breakableSurfaces = ReadBlockArrayData<StructureBspBreakableSurfaceBlock>(binaryReader,
                blamPointers.Dequeue());
            pathfindingData = ReadBlockArrayData<PathfindingDataBlock>(binaryReader, blamPointers.Dequeue());
            pathfindingEdges = ReadBlockArrayData<StructureBspPathfindingEdgesBlock>(binaryReader,
                blamPointers.Dequeue());
            ...
            environmentObjectPalette = ReadBlockArrayData<StructureBspEnvironmentObjectPaletteBlock>(binaryReader,
                blamPointers.Dequeue());
            environmentObjects = ReadBlockArrayData<StructureBspEnvironmentObjectBlock>(binaryReader,
                blamPointers.Dequeue());
            ...
            precomputedLighting = ReadBlockArrayData<StructureBspPrecomputedLightingBlock>(binaryReader,
                blamPointers.Dequeue());
            instancedGeometriesDefinitions =
                ReadBlockArrayData<StructureBspInstancedGeometryDefinitionBlock>(binaryReader, blamPointers.Dequeue());
            instancedGeometryInstances = ReadBlockArrayData<StructureBspInstancedGeometryInstancesBlock>(binaryReader,
                blamPointers.Dequeue());
            ambienceSoundClusters = ReadBlockArrayData<StructureBspSoundClusterBlock>(binaryReader,
                blamPointers.Dequeue());
            ...
            portalDeviceMapping = ReadBlockArrayData<StructurePortalDeviceMappingBlock>(binaryReader,
                blamPointers.Dequeue());
            audibility = ReadBlockArrayData<StructureBspAudibilityBlock>(binaryReader, blamPointers.Dequeue());
            objectFakeLightprobes = ReadBlockArrayData<StructureBspFakeLightprobesBlock>(binaryReader,
                blamPointers.Dequeue());
        ...
        public override int Write(BinaryWriter binaryWriter, int nextAddress)
        {
            ...
            using (binaryWriter.BaseStream.Pin())
            {
                ...
                nextAddress = Guerilla.WriteBlockArray<StructureCollisionMaterialsBlock>(binaryWriter,
                    collisionMaterials, nextAddress);
                ...
                nextAddress = Guerilla.WriteBlockArray<UNUSEDStructureBspNodeBlock>(binaryWriter, uNUSEDNodes,
                    nextAddress);
                ...
                nextAddress = Guerilla.WriteBlockArray<StructureBspClusterPortalBlock>(binaryWriter, clusterPortals,
                    nextAddress);
                ...
                nextAddress = Guerilla.WriteBlockArray<StructureBspWeatherPaletteBlock>(binaryWriter, weatherPalette,
                    nextAddress);
                nextAddress = Guerilla.WriteBlockArray<StructureBspWeatherPolyhedronBlock>(binaryWriter,
                    weatherPolyhedra, nextAddress);
                nextAddress = Guerilla.WriteBlockArray<StructureBspDetailObjectDataBlock>(binaryWriter, detailObjects,
                    nextAddress);
                ...
                nextAddress = Guerilla.WriteBlockArray<StructureBspSkyOwnerClusterBlock>(binaryWriter, skyOwnerCluster,
                    nextAddress);
                nextAddress = Guerilla.WriteBlockArray<StructureBspConveyorSurfaceBlock>(binaryWriter, conveyorSurfaces,
                    nextAddress);
                nextAddress = Guerilla.WriteBlockArray<StructureBspBreakableSurfaceBlock>(binaryWriter,
                    breakableSurfaces, nextAddress);
                nextAddress = Guerilla.WriteBlockArray<PathfindingDataBlock>(binaryWriter, pathfindingData, nextAddress);
                nextAddress = Guerilla.WriteBlockArray<StructureBspPathfindingEdgesBlock>(binaryWriter, pathfindingEdges,
                    nextAddress);
                ...
                nextAddress = Guerilla.WriteBlockArray<StructureBspRuntimeDecalBlock>(binaryWriter, runtimeDecals,
                    nextAddress);
                nextAddress = Guerilla.WriteBlockArray<StructureBspEnvironmentObjectPaletteBlock>(binaryWriter,
                    environmentObjectPalette, nextAddress);
                nextAddress = Guerilla.WriteBlockArray<StructureBspEnvironmentObjectBlock>(binaryWriter,
                    environmentObjects, nextAddress);
                nextAddress = Guerilla.WriteBlockArray<StructureBspLightmapDataBlock>(binaryWriter, lightmaps,
                    nextAddress);
                binaryWriter.Write(invalidName_1, 0, 4);
                nextAddress = Guerilla.WriteBlockArray<GlobalMapLeafBlock>(binaryWriter, leafMapLeaves, nextAddress);
                nextAddress = Guerilla.WriteBlockArray<GlobalLeafConnectionBlock>(binaryWriter, leafMapConnections,
                    nextAddress);
                nextAddress = Guerilla.WriteBlockArray<GlobalErrorReportCategoriesBlock>(binaryWriter, errors,
                    nextAddress);
                nextAddress = Guerilla.WriteBlockArray<StructureBspPrecomputedLightingBlock>(binaryWriter,
                    precomputedLighting, nextAddress);
                nextAddress = Guerilla.WriteBlockArray<StructureBspInstancedGeometryDefinitionBlock>(binaryWriter,
                    instancedGeometriesDefinitions, nextAddress);
                nextAddress = Guerilla.WriteBlockArray<StructureBspInstancedGeometryInstancesBlock>(binaryWriter,
                    instancedGeometryInstances, nextAddress);
                nextAddress = Guerilla.WriteBlockArray<StructureBspSoundClusterBlock>(binaryWriter,
                    ambienceSoundClusters, nextAddress);
                nextAddress = Guerilla.WriteBlockArray<StructureBspSoundClusterBlock>(binaryWriter, reverbSoundClusters,
                    nextAddress);
                nextAddress = Guerilla.WriteBlockArray<TransparentPlanesBlock>(binaryWriter, transparentPlanes,
                    nextAddress);
                ...
                nextAddress = Guerilla.WriteBlockArray<GlobalWaterDefinitionsBlock>(binaryWriter, waterDefinitions,
                    nextAddress);
                nextAddress = Guerilla.WriteBlockArray<StructurePortalDeviceMappingBlock>(binaryWriter,
                    portalDeviceMapping, nextAddress);
                nextAddress = Guerilla.WriteBlockArray<StructureBspAudibilityBlock>(binaryWriter, audibility,
                    nextAddress);
                nextAddress = Guerilla.WriteBlockArray<StructureBspFakeLightprobesBlock>(binaryWriter,
                    objectFakeLightprobes, nextAddress);
                nextAddress = Guerilla.WriteBlockArray<DecoratorPlacementDefinitionBlock>(binaryWriter, decorators0,
                    nextAddress);
                return nextAddress;
            }
        }
