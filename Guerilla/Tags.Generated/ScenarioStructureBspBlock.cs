    ...
    public class ScenarioStructureBspBlockBase : GuerillaBlock
    {
        ...
        internal ScenarioStructureBspBlockBase( BinaryReader binaryReader ) : base( binaryReader )
        {
            ...
            instancedGeometriesDefinitions =
                Guerilla.ReadBlockArray<StructureBspInstancedGeometryDefinitionBlock>( binaryReader );
            instancedGeometryInstances =
                Guerilla.ReadBlockArray<StructureBspInstancedGeometryInstancesBlock>( binaryReader );
        ...
        public override int Write( System.IO.BinaryWriter binaryWriter, Int32 nextAddress )
        {
            using ( binaryWriter.BaseStream.Pin( ) )
            {
                ...
                nextAddress = Guerilla.WriteBlockArray<GlobalGeometryMaterialBlock>( binaryWriter, materials,
                    nextAddress );
                ...
                nextAddress = Guerilla.WriteBlockArray<StructureBspPathfindingEdgesBlock>( binaryWriter,
                    pathfindingEdges, nextAddress );
