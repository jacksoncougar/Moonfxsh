...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class ShaderGpuStateStructBlockBase : GuerillaBlock
    {
        ...
        internal ShaderGpuStateStructBlockBase( BinaryReader binaryReader ) : base( binaryReader )
        {
        ...
        public override int Write( System.IO.BinaryWriter binaryWriter, Int32 nextAddress )
        {
            using ( binaryWriter.BaseStream.Pin( ) )
            {
                ...
                nextAddress = Guerilla.WriteBlockArray<VertexShaderConstantBlock>( binaryWriter, vnConstants,
                    nextAddress );
                nextAddress = Guerilla.WriteBlockArray<VertexShaderConstantBlock>( binaryWriter, cnConstants,
                    nextAddress );
                return nextAddress;
            }
        }
