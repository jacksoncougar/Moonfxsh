    ...
    public class ShaderPostprocessDefinitionNewBlockBase : IGuerilla
    {
        ...
        internal ShaderPostprocessDefinitionNewBlockBase( BinaryReader binaryReader )
        {
            ...
            animatedParameterReferences =
                Guerilla.ReadBlockArray<ShaderPostprocessAnimatedParameterReferenceNewBlock>( binaryReader );
        ...
        public int Write( System.IO.BinaryWriter binaryWriter, Int32 nextAddress )
        {
            using ( binaryWriter.BaseStream.Pin( ) )
            {
                ...
                nextAddress =
                    Guerilla.WriteBlockArray<ShaderPostprocessAnimatedParameterReferenceNewBlock>( binaryWriter,
                        animatedParameterReferences, nextAddress );
