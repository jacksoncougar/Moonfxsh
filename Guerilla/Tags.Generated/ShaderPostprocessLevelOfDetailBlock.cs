...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class ShaderPostprocessLevelOfDetailBlockBase : GuerillaBlock
    {
        ...
        public override void ReadPointers(BinaryReader binaryReader, Queue<BlamPointer> blamPointers)
        {
            ...
            implementations = ReadBlockArrayData<ShaderPostprocessImplementationBlock>(binaryReader, blamPointers.Dequeue());
            bitmaps = ReadBlockArrayData<ShaderPostprocessBitmapBlock>(binaryReader, blamPointers.Dequeue());
            bitmapTransforms = ReadBlockArrayData<ShaderPostprocessBitmapTransformBlock>(binaryReader, blamPointers.Dequeue());
            ...
            bitmapTransformOverlays = ReadBlockArrayData<ShaderPostprocessBitmapTransformOverlayBlock>(binaryReader, blamPointers.Dequeue());
            ...
            vertexShaderConstants = ReadBlockArrayData<ShaderPostprocessVertexShaderConstantBlock>(binaryReader, blamPointers.Dequeue());
