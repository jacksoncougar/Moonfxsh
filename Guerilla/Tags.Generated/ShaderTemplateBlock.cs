    ...
    public class ShaderTemplateBlockBase : GuerillaBlock
    {
        ...
        public override Queue<BlamPointer> ReadFields(BinaryReader binaryReader)
        {
            ...
            blamPointers.Enqueue(
                ReadBlockArrayPointer<ShaderTemplateRuntimeExternalLightResponseIndexBlock>(binaryReader));
            blamPointers.Enqueue(
                ReadBlockArrayPointer<ShaderTemplateRuntimeExternalLightResponseIndexBlock>(binaryReader));
        ...
        public override void ReadPointers(BinaryReader binaryReader, Queue<BlamPointer> blamPointers)
        {
            ...
            eMPTYSTRING = ReadBlockArrayData<ShaderTemplateRuntimeExternalLightResponseIndexBlock>(binaryReader,
                blamPointers.Dequeue());
            eMPTYSTRING0 = ReadBlockArrayData<ShaderTemplateRuntimeExternalLightResponseIndexBlock>(binaryReader,
                blamPointers.Dequeue());
            postprocessDefinition = ReadBlockArrayData<ShaderTemplatePostprocessDefinitionNewBlock>(binaryReader,
                blamPointers.Dequeue());
        }
