...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class SoundCacheFileGestaltBlockBase : IGuerilla
    {
        ...
        internal SoundCacheFileGestaltBlockBase( BinaryReader binaryReader )
        {
            ...
            runtimePermutationFlags =
                Guerilla.ReadBlockArray<SoundGestaltRuntimePermutationBitVectorBlock>( binaryReader );
        ...
        public int Write( System.IO.BinaryWriter binaryWriter, Int32 nextAddress )
        {
            using ( binaryWriter.BaseStream.Pin( ) )
            {
                ...
                nextAddress = Guerilla.WriteBlockArray<SoundGestaltPromotionsBlock>( binaryWriter, promotions,
                    nextAddress );
                nextAddress = Guerilla.WriteBlockArray<SoundGestaltExtraInfoBlock>( binaryWriter, extraInfos,
                    nextAddress );
                return nextAddress;
            }
        }
