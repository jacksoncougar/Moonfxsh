...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class StructureLightmapGroupBlockBase : GuerillaBlock
    {
        ...
        public override void ReadPointers(BinaryReader binaryReader, Queue<BlamPointer> blamPointers)
        {
            ...
            writablePalettes = ReadBlockArrayData<StructureLightmapPaletteColorBlock>(binaryReader,
            ...
            lightingEnvironments = ReadBlockArrayData<StructureLightmapLightingEnvironmentBlock>(binaryReader,
                blamPointers.Dequeue());
            geometryBuckets = ReadBlockArrayData<LightmapVertexBufferBucketBlock>(binaryReader, blamPointers.Dequeue());
            instanceRenderInfo = ReadBlockArrayData<LightmapGeometryRenderInfoBlock>(binaryReader,
                blamPointers.Dequeue());
            instanceBucketRefs = ReadBlockArrayData<LightmapInstanceBucketReferenceBlock>(binaryReader,
                blamPointers.Dequeue());
            sceneryObjectInfo = ReadBlockArrayData<LightmapSceneryObjectInfoBlock>(binaryReader, blamPointers.Dequeue());
            sceneryObjectBucketRefs = ReadBlockArrayData<LightmapInstanceBucketReferenceBlock>(binaryReader,
                blamPointers.Dequeue());
        }
        ...
        public override int Write(BinaryWriter binaryWriter, int nextAddress)
        {
            ...
            using (binaryWriter.BaseStream.Pin())
            {
                ...
                nextAddress = Guerilla.WriteBlockArray<LightmapVertexBufferBucketBlock>(binaryWriter, geometryBuckets,
                    nextAddress);
                nextAddress = Guerilla.WriteBlockArray<LightmapGeometryRenderInfoBlock>(binaryWriter, instanceRenderInfo,
                    nextAddress);
