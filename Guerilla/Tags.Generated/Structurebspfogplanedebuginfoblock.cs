...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class StructureBspFogPlaneDebugInfoBlockBase : GuerillaBlock
    {
        ...
        public override void ReadPointers(BinaryReader binaryReader, Queue<BlamPointer> blamPointers)
        {
            ...
            intersectedClusterIndices = ReadBlockArrayData<StructureBspDebugInfoIndicesBlock>(binaryReader,
                blamPointers.Dequeue());
            infExtentClusterIndices = ReadBlockArrayData<StructureBspDebugInfoIndicesBlock>(binaryReader,
                blamPointers.Dequeue());
        }
