...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public VocalizationDefinitionsBlock0() : base()
        {
        }
    };
    ...
    public class VocalizationDefinitionsBlock0Base : GuerillaBlock
    {
        ...
        public VocalizationDefinitionsBlock0Base() : base()
        {
        }
        public override Queue<BlamPointer> ReadFields(BinaryReader binaryReader)
        {
            ...
            blamPointers.Enqueue(ReadBlockArrayPointer<VocalizationDefinitionsBlock1>(binaryReader));
            return blamPointers;
        }
        public override void ReadPointers(BinaryReader binaryReader, Queue<BlamPointer> blamPointers)
        {
            ...
            children = ReadBlockArrayData<VocalizationDefinitionsBlock1>(binaryReader, blamPointers.Dequeue());
        }
...
using(binaryWriter.BaseStream.Pin())
            {
                ...
                nextAddress = Guerilla.WriteBlockArray<VocalizationDefinitionsBlock1>(binaryWriter, children, nextAddress);
                return nextAddress;
            }
        }
