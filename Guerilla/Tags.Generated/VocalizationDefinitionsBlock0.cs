...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class VocalizationDefinitionsBlock0Base : IGuerilla
    {
        ...
        internal VocalizationDefinitionsBlock0Base( BinaryReader binaryReader )
        {
            ...
            children = Guerilla.ReadBlockArray<VocalizationDefinitionsBlock1>( binaryReader );
        }
        ...
        public int Write( System.IO.BinaryWriter binaryWriter, Int32 nextAddress )
        {
            using ( binaryWriter.BaseStream.Pin( ) )
            {
                ...
                nextAddress = Guerilla.WriteBlockArray<VocalizationDefinitionsBlock1>( binaryWriter, children,
                    nextAddress );
                return nextAddress;
            }
        }
