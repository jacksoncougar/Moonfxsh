...
namespace Moonfish.Guerilla.Tags
{
    public partial class VocalizationDefinitionsBlock1 : VocalizationDefinitionsBlock1Base
    {
        ...
        public  VocalizationDefinitionsBlock1(): base()
        {
            
        }
    };
    [LayoutAttribute(Size = 96, Alignment = 4)]
    public class VocalizationDefinitionsBlock1Base : GuerillaBlock
    {
        ...
        public  VocalizationDefinitionsBlock1Base(BinaryReader binaryReader): base(binaryReader)
        {
        ...
        public  VocalizationDefinitionsBlock1Base(): base()
        {
        ...
        public override int Write(System.IO.BinaryWriter binaryWriter, Int32 nextAddress)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                nextAddress = Guerilla.WriteBlockArray<VocalizationDefinitionsBlock2>(binaryWriter, children, nextAddress);
                return nextAddress;
            }
        }
