...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class VocalizationDefinitionsBlock1Base : IGuerilla
    {
        ...
        internal VocalizationDefinitionsBlock1Base( BinaryReader binaryReader )
        {
            ...
            glanceBehavior =
                ( GlanceBehaviorHowDoesTheSpeakerOfThisVocalizationDirectHisGaze ) binaryReader.ReadInt16( );
            glanceRecipientBehavior =
                ( GlanceRecipientBehaviorHowDoesSomeoneWhoHearsMeBehave ) binaryReader.ReadInt16( );
            ...
            children = Guerilla.ReadBlockArray<VocalizationDefinitionsBlock2>( binaryReader );
        }
        ...
        public int Write( System.IO.BinaryWriter binaryWriter, Int32 nextAddress )
        {
            using ( binaryWriter.BaseStream.Pin( ) )
            {
                ...
                nextAddress = Guerilla.WriteBlockArray<VocalizationDefinitionsBlock2>( binaryWriter, children,
                    nextAddress );
                return nextAddress;
            }
        }
