...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class VocalizationDefinitionsBlock1Base : GuerillaBlock
    {
        ...
        public override Queue<BlamPointer> ReadFields(BinaryReader binaryReader)
        {
            ...
            blamPointers.Enqueue(ReadBlockArrayPointer<VocalizationDefinitionsBlock2>(binaryReader));
            return blamPointers;
        }
        public override void ReadPointers(BinaryReader binaryReader, Queue<BlamPointer> blamPointers)
        {
            ...
            children = ReadBlockArrayData<VocalizationDefinitionsBlock2>(binaryReader, blamPointers.Dequeue());
        }
