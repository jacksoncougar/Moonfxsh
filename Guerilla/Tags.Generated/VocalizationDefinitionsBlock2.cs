...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class VocalizationDefinitionsBlock2Base : GuerillaBlock
    {
        ...
        internal  VocalizationDefinitionsBlock2Base(BinaryReader binaryReader): base(binaryReader)
        {
        ...
        public override int Write(System.IO.BinaryWriter binaryWriter, Int32 nextAddress)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                nextAddress = Guerilla.WriteBlockArray<VocalizationDefinitionsBlock3>(binaryWriter, children, nextAddress);
                return nextAddress;
            }
        }
