...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  VocalizationDefinitionsBlock3(BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class VocalizationDefinitionsBlock3Base : GuerillaBlock
    {
        ...
        public  VocalizationDefinitionsBlock3Base(BinaryReader binaryReader): base(binaryReader)
        {
