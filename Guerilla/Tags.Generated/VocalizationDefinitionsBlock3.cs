...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public VocalizationDefinitionsBlock3() : base()
        {
        }
    };
    [LayoutAttribute(Size = 96, Alignment = 4)]
    public class VocalizationDefinitionsBlock3Base : GuerillaBlock
    {
        ...
        public VocalizationDefinitionsBlock3Base() : base()
        {
        }
        public override Queue<BlamPointer> ReadFields(BinaryReader binaryReader)
        {
            ...
            blamPointers.Enqueue(ReadBlockArrayPointer<VocalizationDefinitionsBlock4>(binaryReader));
            return blamPointers;
        }
        public override void ReadPointers(BinaryReader binaryReader, Queue<BlamPointer> blamPointers)
        {
            ...
            children = ReadBlockArrayData<VocalizationDefinitionsBlock4>(binaryReader, blamPointers.Dequeue());
        }
...
using(binaryWriter.BaseStream.Pin())
            {
                ...
                nextAddress = Guerilla.WriteBlockArray<VocalizationDefinitionsBlock4>(binaryWriter, children, nextAddress);
                return nextAddress;
            }
        }
