...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public VocalizationDefinitionsBlock4() : base()
        {
        }
    };
    ...
    public class VocalizationDefinitionsBlock4Base : GuerillaBlock
    {
        ...
        public VocalizationDefinitionsBlock4Base() : base()
        {
        }
        ...
        public override Queue<BlamPointer> ReadFields(BinaryReader binaryReader)
        {
            ...
            blamPointers.Enqueue(ReadBlockArrayPointer<VocalizationDefinitionsBlock5>(binaryReader));
            return blamPointers;
        }
        ...
        public override void ReadPointers(BinaryReader binaryReader, Queue<BlamPointer> blamPointers)
        {
            ...
            children = ReadBlockArrayData<VocalizationDefinitionsBlock5>(binaryReader, blamPointers.Dequeue());
        }
