...
namespace Moonfish.Guerilla.Tags
{
    public partial class VocalizationDefinitionsBlock5 : VocalizationDefinitionsBlock5Base
    {
        ...
        public  VocalizationDefinitionsBlock5(): base()
        {
            
        }
    };
    [LayoutAttribute(Size = 96, Alignment = 4)]
    public class VocalizationDefinitionsBlock5Base : GuerillaBlock
    {
        ...
        public  VocalizationDefinitionsBlock5Base(BinaryReader binaryReader): base(binaryReader)
        {
        ...
        public  VocalizationDefinitionsBlock5Base(): base()
        {
