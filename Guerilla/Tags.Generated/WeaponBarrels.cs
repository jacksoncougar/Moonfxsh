...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class WeaponBarrelsBase : GuerillaBlock
    {
        ...
        public override Queue<BlamPointer> ReadFields(BinaryReader binaryReader)
        {
            ...
            angleChangeFunction =
                (AngleChangeFunctionFunctionUsedToScaleBetweenInitialAndFinalAngleChangePerShot)
        ...
        public override int Write(BinaryWriter binaryWriter, int nextAddress)
        {
            ...
            using (binaryWriter.BaseStream.Pin())
            {
                ...
                nextAddress = Guerilla.WriteBlockArray<BarrelFiringEffectBlock>(binaryWriter, firingEffects, nextAddress);
                return nextAddress;
            }
        }
        ...
        internal enum Flags : int
        {
            ...
            ProjectilesUseWeaponOriginInsteadOfComingOutOfTheMagicFirstPersonCameraOriginTheProjectilesForThisWeaponActuallyComeOutOfTheGun
                = 8,
            EjectsDuringChamberThisTriggersEjectionPortIsStartedDuringTheKeyFrameOfItsChamberAnimation = 16,
            UseErrorWhenUnzoomed = 32,

            ProjectileVectorCannotBeAdjustedProjectilesFiredByThisWeaponCannotHaveTheirDirectionAdjustedByTheAIToHitTheTarget
                = 64,
            ProjectilesHaveIdenticalError = 128,

            ProjectilesFireParallelIfThereAreMultipleGunsForThisTriggerTheProjectilesEmergeInParallelBeamsRatherThanIndependantAiming
                = 256,
