    ...
    public class AnimationModeBlockBase  : IGuerilla
    {
        ...
        public int Write(System.IO.BinaryWriter binaryWriter, Int32 nextAddress)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                Guerilla.WriteBlockArray<WeaponClassBlock>(binaryWriter, weaponClassAABBCC, nextAddress);
                Guerilla.WriteBlockArray<AnimationIkBlock>(binaryWriter, modeIkAABBCC, nextAddress);
