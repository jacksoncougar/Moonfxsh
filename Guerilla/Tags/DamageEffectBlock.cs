...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class DamageEffectBlockBase : IGuerilla
    {
        ...
        internal DamageEffectBlockBase( BinaryReader binaryReader )
        {
            ...
            falloffFunction =
                ( FalloffFunctionAFunctionToEnvelopeTheEffectsMagnitudeOverTime ) binaryReader.ReadInt16( );
        ...
        public int Write( System.IO.BinaryWriter binaryWriter, Int32 nextAddress )
        {
            using ( binaryWriter.BaseStream.Pin( ) )
            {
                ...
                nextAddress = Guerilla.WriteBlockArray<DamageEffectPlayerResponseBlock>( binaryWriter, playerResponses,
                    nextAddress );
