    ...
    public class GlobalNewHudGlobalsStructBlockBase  : IGuerilla
    {
        ...
        public int Write(System.IO.BinaryWriter binaryWriter, Int32 nextAddress)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                Guerilla.WriteBlockArray<HudDashlightsBlock>(binaryWriter, dashlights, nextAddress);
                Guerilla.WriteBlockArray<HudWaypointArrowBlock>(binaryWriter, waypointArrows, nextAddress);
                Guerilla.WriteBlockArray<HudWaypointBlock>(binaryWriter, waypoints, nextAddress);
                Guerilla.WriteBlockArray<NewHudSoundBlock>(binaryWriter, hudSounds, nextAddress);
                Guerilla.WriteBlockArray<PlayerTrainingEntryDataBlock>(binaryWriter, playerTrainingData, nextAddress);
