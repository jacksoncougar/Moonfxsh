...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class GlobalCollisionBspStructBlockBase  : IGuerilla
    {
        ...
        public int Write(System.IO.BinaryWriter binaryWriter, Int32 nextAddress)
        {
            ...
            {
                Guerilla.WriteBlockArray<Bsp3dNodesBlock>(binaryWriter, bSP3DNodes, nextAddress);
                Guerilla.WriteBlockArray<PlanesBlock>(binaryWriter, planes, nextAddress);
                Guerilla.WriteBlockArray<LeavesBlock>(binaryWriter, leaves, nextAddress);
                Guerilla.WriteBlockArray<Bsp2dReferencesBlock>(binaryWriter, bSP2DReferences, nextAddress);
                Guerilla.WriteBlockArray<Bsp2dNodesBlock>(binaryWriter, bSP2DNodes, nextAddress);
                Guerilla.WriteBlockArray<SurfacesBlock>(binaryWriter, surfaces, nextAddress);
                Guerilla.WriteBlockArray<EdgesBlock>(binaryWriter, edges, nextAddress);
                Guerilla.WriteBlockArray<VerticesBlock>(binaryWriter, vertices, nextAddress);
