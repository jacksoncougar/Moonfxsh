...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class GrenadeHudInterfaceBlockBase  : IGuerilla
    {
        ...
        public int Write(System.IO.BinaryWriter binaryWriter, Int32 nextAddress)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                Guerilla.WriteBlockArray<GrenadeHudOverlayBlock>(binaryWriter, overlays, nextAddress);
                Guerilla.WriteBlockArray<GrenadeHudSoundBlock>(binaryWriter, warningSounds, nextAddress);
