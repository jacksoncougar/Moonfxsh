    ...
    public class MultiplayerRuntimeBlockBase  : IGuerilla
    {
        ...
        public int Write(System.IO.BinaryWriter binaryWriter, Int32 nextAddress)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                Guerilla.WriteBlockArray<WeaponsBlock>(binaryWriter, weapons, nextAddress);
                Guerilla.WriteBlockArray<VehiclesBlock>(binaryWriter, vehicles, nextAddress);
                arr.Write(binaryWriter);
                binaryWriter.Write(inGameText);
                Guerilla.WriteBlockArray<SoundsBlock>(binaryWriter, sounds, nextAddress);
                Guerilla.WriteBlockArray<GameEngineGeneralEventBlock>(binaryWriter, generalEvents, nextAddress);
                Guerilla.WriteBlockArray<GameEngineFlavorEventBlock>(binaryWriter, flavorEvents, nextAddress);
                Guerilla.WriteBlockArray<GameEngineSlayerEventBlock>(binaryWriter, slayerEvents, nextAddress);
                Guerilla.WriteBlockArray<GameEngineCtfEventBlock>(binaryWriter, ctfEvents, nextAddress);
                Guerilla.WriteBlockArray<GameEngineOddballEventBlock>(binaryWriter, oddballEvents, nextAddress);
                Guerilla.WriteBlockArray<GNullBlock>(binaryWriter, gNullBlock, nextAddress);
                Guerilla.WriteBlockArray<GameEngineKingEventBlock>(binaryWriter, kingEvents, nextAddress);
                Guerilla.WriteBlockArray<GNullBlock>(binaryWriter, gNullBlock0, nextAddress);
                Guerilla.WriteBlockArray<GameEngineJuggernautEventBlock>(binaryWriter, juggernautEvents, nextAddress);
                Guerilla.WriteBlockArray<GameEngineTerritoriesEventBlock>(binaryWriter, territoriesEvents, nextAddress);
                Guerilla.WriteBlockArray<GameEngineAssaultEventBlock>(binaryWriter, invasionEvents, nextAddress);
                Guerilla.WriteBlockArray<GNullBlock>(binaryWriter, gNullBlock1, nextAddress);
                Guerilla.WriteBlockArray<GNullBlock>(binaryWriter, gNullBlock2, nextAddress);
                Guerilla.WriteBlockArray<GNullBlock>(binaryWriter, gNullBlock3, nextAddress);
                Guerilla.WriteBlockArray<GNullBlock>(binaryWriter, gNullBlock4, nextAddress);
                ...
                Guerilla.WriteBlockArray<MultiplayerConstantsBlock>(binaryWriter, multiplayerConstants, nextAddress);
                Guerilla.WriteBlockArray<GameEngineStatusResponseBlock>(binaryWriter, stateResponses, nextAddress);
