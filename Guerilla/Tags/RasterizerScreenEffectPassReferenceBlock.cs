...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class RasterizerScreenEffectPassReferenceBlockBase : IGuerilla
    {
        ...
        internal RasterizerScreenEffectPassReferenceBlockBase( BinaryReader binaryReader )
        {
            ...
            advancedControl =
                Guerilla.ReadBlockArray<RasterizerScreenEffectTexcoordGenerationAdvancedControlBlock>( binaryReader );
        ...
        public int Write( System.IO.BinaryWriter binaryWriter, Int32 nextAddress )
        {
            using ( binaryWriter.BaseStream.Pin( ) )
            {
                ...
                nextAddress = Guerilla.WriteBlockArray<RasterizerScreenEffectConvolutionBlock>( binaryWriter,
                    convolution, nextAddress );
                return nextAddress;
            }
        }
