    ...
    public class RenderModelBlockBase : IGuerilla
    {
        ...
        public int Write( System.IO.BinaryWriter binaryWriter, Int32 nextAddress )
        {
            using ( binaryWriter.BaseStream.Pin( ) )
            {
                ...
                nextAddress = Guerilla.WriteBlockArray<GlobalGeometryCompressionInfoBlock>( binaryWriter,
                    compressionInfo, nextAddress );
                ...
                nextAddress = Guerilla.WriteBlockArray<RenderModelNodeMapBlockOLD>( binaryWriter, nodeMapOLD,
                    nextAddress );
