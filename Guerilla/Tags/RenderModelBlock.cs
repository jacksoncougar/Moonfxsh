    ...
    public class RenderModelBlockBase  : IGuerilla
    {
        ...
        public int Write(System.IO.BinaryWriter binaryWriter, Int32 nextAddress)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                Guerilla.WriteBlockArray<GlobalGeometryCompressionInfoBlock>(binaryWriter, compressionInfo, nextAddress);
                Guerilla.WriteBlockArray<RenderModelRegionBlock>(binaryWriter, regions, nextAddress);
                Guerilla.WriteBlockArray<RenderModelSectionBlock>(binaryWriter, sections, nextAddress);
                Guerilla.WriteBlockArray<RenderModelInvalidSectionPairsBlock>(binaryWriter, invalidSectionPairBits, nextAddress);
                Guerilla.WriteBlockArray<RenderModelSectionGroupBlock>(binaryWriter, sectionGroups, nextAddress);
                ...
                Guerilla.WriteBlockArray<RenderModelNodeBlock>(binaryWriter, nodes, nextAddress);
                Guerilla.WriteBlockArray<RenderModelNodeMapBlockOLD>(binaryWriter, nodeMapOLD, nextAddress);
                Guerilla.WriteBlockArray<RenderModelMarkerGroupBlock>(binaryWriter, markerGroups, nextAddress);
                ...
                Guerilla.WriteBlockArray<PrtInfoBlock>(binaryWriter, pRTInfo, nextAddress);
                Guerilla.WriteBlockArray<SectionRenderLeavesBlock>(binaryWriter, sectionRenderLeaves, nextAddress);
