...
namespace Moonfish.Tags
{
    ...
    {
        public static readonly TagClass Cin*Class = (TagClass)"cin*";
    };
};
...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class ScenarioCinematicsResourceBlockBase  : IGuerilla
    {
        ...
        public int Write(System.IO.BinaryWriter binaryWriter, Int32 nextAddress)
        {
            ...
            {
                Guerilla.WriteBlockArray<ScenarioCutsceneFlagBlock>(binaryWriter, flags, nextAddress);
                Guerilla.WriteBlockArray<ScenarioCutsceneCameraPointBlock>(binaryWriter, cameraPoints, nextAddress);
