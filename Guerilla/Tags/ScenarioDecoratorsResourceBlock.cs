...
namespace Moonfish.Tags
{
    ...
    {
        public static readonly TagClass Dc*SClass = (TagClass)"dc*s";
    };
};
...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class ScenarioDecoratorsResourceBlockBase  : IGuerilla
    {
        ...
        public int Write(System.IO.BinaryWriter binaryWriter, Int32 nextAddress)
        {
            ...
            {
                Guerilla.WriteBlockArray<DecoratorPlacementDefinitionBlock>(binaryWriter, decorator, nextAddress);
                Guerilla.WriteBlockArray<ScenarioDecoratorSetPaletteEntryBlock>(binaryWriter, decoratorPalette, nextAddress);
