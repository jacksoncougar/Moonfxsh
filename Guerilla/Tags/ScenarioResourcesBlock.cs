...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class ScenarioResourcesBlockBase  : IGuerilla
    {
        ...
        public int Write(System.IO.BinaryWriter binaryWriter, Int32 nextAddress)
        {
            ...
            {
                Guerilla.WriteBlockArray<ScenarioResourceReferenceBlock>(binaryWriter, references, nextAddress);
                Guerilla.WriteBlockArray<ScenarioHsSourceReferenceBlock>(binaryWriter, scriptSource, nextAddress);
                Guerilla.WriteBlockArray<ScenarioAiResourceReferenceBlock>(binaryWriter, aIResources, nextAddress);
