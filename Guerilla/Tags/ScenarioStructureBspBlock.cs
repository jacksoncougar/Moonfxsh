    ...
    public class ScenarioStructureBspBlockBase  : IGuerilla
    {
        ...
        public int Write(System.IO.BinaryWriter binaryWriter, Int32 nextAddress)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                Guerilla.WriteBlockArray<StructureCollisionMaterialsBlock>(binaryWriter, collisionMaterials, nextAddress);
                Guerilla.WriteBlockArray<GlobalCollisionBspBlock>(binaryWriter, collisionBSP, nextAddress);
                binaryWriter.Write(vehicleFloorWorldUnits);
                binaryWriter.Write(vehicleCeilingWorldUnits);
                Guerilla.WriteBlockArray<UNUSEDStructureBspNodeBlock>(binaryWriter, uNUSEDNodes, nextAddress);
                Guerilla.WriteBlockArray<StructureBspLeafBlock>(binaryWriter, leaves, nextAddress);
                ...
                Guerilla.WriteBlockArray<StructureBspClusterPortalBlock>(binaryWriter, clusterPortals, nextAddress);
                Guerilla.WriteBlockArray<StructureBspFogPlaneBlock>(binaryWriter, fogPlanes, nextAddress);
                ...
                Guerilla.WriteBlockArray<StructureBspWeatherPolyhedronBlock>(binaryWriter, weatherPolyhedra, nextAddress);
                Guerilla.WriteBlockArray<StructureBspDetailObjectDataBlock>(binaryWriter, detailObjects, nextAddress);
                Guerilla.WriteBlockArray<StructureBspClusterBlock>(binaryWriter, clusters, nextAddress);
                Guerilla.WriteBlockArray<GlobalGeometryMaterialBlock>(binaryWriter, materials, nextAddress);
                Guerilla.WriteBlockArray<StructureBspSkyOwnerClusterBlock>(binaryWriter, skyOwnerCluster, nextAddress);
                Guerilla.WriteBlockArray<StructureBspConveyorSurfaceBlock>(binaryWriter, conveyorSurfaces, nextAddress);
                Guerilla.WriteBlockArray<StructureBspBreakableSurfaceBlock>(binaryWriter, breakableSurfaces, nextAddress);
                Guerilla.WriteBlockArray<PathfindingDataBlock>(binaryWriter, pathfindingData, nextAddress);
                Guerilla.WriteBlockArray<StructureBspPathfindingEdgesBlock>(binaryWriter, pathfindingEdges, nextAddress);
                ...
                Guerilla.WriteData(binaryWriter);
                Guerilla.WriteBlockArray<StructureBspMarkerBlock>(binaryWriter, markers, nextAddress);
                Guerilla.WriteBlockArray<StructureBspRuntimeDecalBlock>(binaryWriter, runtimeDecals, nextAddress);
                Guerilla.WriteBlockArray<StructureBspEnvironmentObjectPaletteBlock>(binaryWriter, environmentObjectPalette, nextAddress);
                Guerilla.WriteBlockArray<StructureBspEnvironmentObjectBlock>(binaryWriter, environmentObjects, nextAddress);
                Guerilla.WriteBlockArray<StructureBspLightmapDataBlock>(binaryWriter, lightmaps, nextAddress);
                binaryWriter.Write(invalidName_1, 0, 4);
                Guerilla.WriteBlockArray<GlobalMapLeafBlock>(binaryWriter, leafMapLeaves, nextAddress);
                Guerilla.WriteBlockArray<GlobalLeafConnectionBlock>(binaryWriter, leafMapConnections, nextAddress);
                Guerilla.WriteBlockArray<GlobalErrorReportCategoriesBlock>(binaryWriter, errors, nextAddress);
                Guerilla.WriteBlockArray<StructureBspPrecomputedLightingBlock>(binaryWriter, precomputedLighting, nextAddress);
                Guerilla.WriteBlockArray<StructureBspInstancedGeometryDefinitionBlock>(binaryWriter, instancedGeometriesDefinitions, nextAddress);
                Guerilla.WriteBlockArray<StructureBspInstancedGeometryInstancesBlock>(binaryWriter, instancedGeometryInstances, nextAddress);
                Guerilla.WriteBlockArray<StructureBspSoundClusterBlock>(binaryWriter, ambienceSoundClusters, nextAddress);
                Guerilla.WriteBlockArray<StructureBspSoundClusterBlock>(binaryWriter, reverbSoundClusters, nextAddress);
                Guerilla.WriteBlockArray<TransparentPlanesBlock>(binaryWriter, transparentPlanes, nextAddress);
                ...
                Guerilla.WriteBlockArray<StructureBspDebugInfoBlock>(binaryWriter, debugInfo, nextAddress);
                binaryWriter.Write(decorators);
                structurePhysics.Write(binaryWriter);
                Guerilla.WriteBlockArray<GlobalWaterDefinitionsBlock>(binaryWriter, waterDefinitions, nextAddress);
                Guerilla.WriteBlockArray<StructurePortalDeviceMappingBlock>(binaryWriter, portalDeviceMapping, nextAddress);
                Guerilla.WriteBlockArray<StructureBspAudibilityBlock>(binaryWriter, audibility, nextAddress);
                Guerilla.WriteBlockArray<StructureBspFakeLightprobesBlock>(binaryWriter, objectFakeLightprobes, nextAddress);
                Guerilla.WriteBlockArray<DecoratorPlacementDefinitionBlock>(binaryWriter, decorators0, nextAddress);
