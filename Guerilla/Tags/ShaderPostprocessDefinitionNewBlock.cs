    ...
    public class ShaderPostprocessDefinitionNewBlockBase  : IGuerilla
    {
        ...
        public int Write(System.IO.BinaryWriter binaryWriter, Int32 nextAddress)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                Guerilla.WriteBlockArray<ShaderPostprocessBitmapNewBlock>(binaryWriter, bitmaps, nextAddress);
                Guerilla.WriteBlockArray<Pixel32Block>(binaryWriter, pixelConstants, nextAddress);
                Guerilla.WriteBlockArray<RealVector4dBlock>(binaryWriter, vertexConstants, nextAddress);
                Guerilla.WriteBlockArray<ShaderPostprocessLevelOfDetailNewBlock>(binaryWriter, levelsOfDetail, nextAddress);
                Guerilla.WriteBlockArray<TagBlockIndexBlock>(binaryWriter, layers, nextAddress);
                Guerilla.WriteBlockArray<TagBlockIndexBlock>(binaryWriter, passes, nextAddress);
                Guerilla.WriteBlockArray<ShaderPostprocessImplementationNewBlock>(binaryWriter, implementations, nextAddress);
                Guerilla.WriteBlockArray<ShaderPostprocessOverlayNewBlock>(binaryWriter, overlays, nextAddress);
                Guerilla.WriteBlockArray<ShaderPostprocessOverlayReferenceNewBlock>(binaryWriter, overlayReferences, nextAddress);
                Guerilla.WriteBlockArray<ShaderPostprocessAnimatedParameterNewBlock>(binaryWriter, animatedParameters, nextAddress);
                Guerilla.WriteBlockArray<ShaderPostprocessAnimatedParameterReferenceNewBlock>(binaryWriter, animatedParameterReferences, nextAddress);
                Guerilla.WriteBlockArray<ShaderPostprocessBitmapPropertyBlock>(binaryWriter, bitmapProperties, nextAddress);
                Guerilla.WriteBlockArray<ShaderPostprocessColorPropertyBlock>(binaryWriter, colorProperties, nextAddress);
                Guerilla.WriteBlockArray<ShaderPostprocessValuePropertyBlock>(binaryWriter, valueProperties, nextAddress);
                Guerilla.WriteBlockArray<ShaderPostprocessLevelOfDetailBlock>(binaryWriter, oldLevelsOfDetail, nextAddress);
