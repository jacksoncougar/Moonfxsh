...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class SoundExtraInfoBlockBase  : IGuerilla
    {
        ...
        public int Write(System.IO.BinaryWriter binaryWriter, Int32 nextAddress)
        {
            ...
            {
                Guerilla.WriteBlockArray<SoundDefinitionLanguagePermutationInfoBlock>(binaryWriter, languagePermutationInfo, nextAddress);
                Guerilla.WriteBlockArray<SoundEncodedDialogueSectionBlock>(binaryWriter, encodedPermutationSection, nextAddress);
