    ...
    public class UserInterfaceSharedGlobalsDefinitionBlockBase  : IGuerilla
    {
        ...
        public int Write(System.IO.BinaryWriter binaryWriter, Int32 nextAddress)
        {
            using(binaryWriter.BaseStream.Pin())
            {
                ...
                Guerilla.WriteBlockArray<UiErrorCategoryBlock>(binaryWriter, errors, nextAddress);
                ...
                Guerilla.WriteBlockArray<AnimationReferenceBlock>(binaryWriter, screenAnimations, nextAddress);
                Guerilla.WriteBlockArray<ShapeGroupReferenceBlock>(binaryWriter, shapeGroups, nextAddress);
                Guerilla.WriteBlockArray<PersistentBackgroundAnimationBlock>(binaryWriter, animations, nextAddress);
                Guerilla.WriteBlockArray<ListSkinReferenceBlock>(binaryWriter, listItemSkins, nextAddress);
                binaryWriter.Write(buttonKeyTypeStrings);
                binaryWriter.Write(gameTypeStrings);
                binaryWriter.Write(invalidName_12);
                Guerilla.WriteBlockArray<SkillToRankMappingBlock>(binaryWriter, skillMappings, nextAddress);
