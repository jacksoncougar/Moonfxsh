...
namespace Moonfish.Guerilla.Tags
{
    ...
    {
        public  VocalizationDefinitionsBlock1(BinaryReader binaryReader): base(binaryReader)
        {
    ...
    public class VocalizationDefinitionsBlock1Base
    {
        ...
        internal  VocalizationDefinitionsBlock1Base(BinaryReader binaryReader)
        {
            ...
            this.children = ReadVocalizationDefinitionsBlock2Array(binaryReader);
        }
        ...
        internal  virtual VocalizationDefinitionsBlock2[] ReadVocalizationDefinitionsBlock2Array(BinaryReader binaryReader)
        {
            var elementSize = Deserializer.SizeOf(typeof(VocalizationDefinitionsBlock2));
            var blamPointer = binaryReader.ReadBlamPointer(elementSize);
            var array = new VocalizationDefinitionsBlock2[blamPointer.elementCount];
            using (binaryReader.BaseStream.Pin())
            {
                for (int i = 0; i < blamPointer.elementCount; ++i)
                {
