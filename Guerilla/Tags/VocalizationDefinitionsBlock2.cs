...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class VocalizationDefinitionsBlock2Base
    {
        ...
        internal  VocalizationDefinitionsBlock2Base(BinaryReader binaryReader)
        {
            ...
            this.children = ReadVocalizationDefinitionsBlock3Array(binaryReader);
        }
        ...
        internal  virtual VocalizationDefinitionsBlock3[] ReadVocalizationDefinitionsBlock3Array(BinaryReader binaryReader)
        {
            var elementSize = Deserializer.SizeOf(typeof(VocalizationDefinitionsBlock3));
            var blamPointer = binaryReader.ReadBlamPointer(elementSize);
            var array = new VocalizationDefinitionsBlock3[blamPointer.elementCount];
            using (binaryReader.BaseStream.Pin())
            {
                for (int i = 0; i < blamPointer.elementCount; ++i)
                {
