...
namespace Moonfish.Guerilla.Tags
{
    ...
    public class VocalizationDefinitionsBlock4Base
    {
        ...
        internal  VocalizationDefinitionsBlock4Base(BinaryReader binaryReader)
        {
            ...
            this.children = ReadVocalizationDefinitionsBlock5Array(binaryReader);
        }
        ...
        internal  virtual VocalizationDefinitionsBlock5[] ReadVocalizationDefinitionsBlock5Array(BinaryReader binaryReader)
        {
            var elementSize = Deserializer.SizeOf(typeof(VocalizationDefinitionsBlock5));
            var blamPointer = binaryReader.ReadBlamPointer(elementSize);
            var array = new VocalizationDefinitionsBlock5[blamPointer.elementCount];
            using (binaryReader.BaseStream.Pin())
            {
                for (int i = 0; i < blamPointer.elementCount; ++i)
                {
