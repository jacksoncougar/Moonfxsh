...
{
    public partial class VocalizationDefinitionsBlock5 : VocalizationDefinitionsBlock5Base
    {
        public VocalizationDefinitionsBlock5( BinaryReader binaryReader ) : base( binaryReader )
        {
        }
    };

    [LayoutAttribute( Size = 96, Alignment = 4 )]
    public class VocalizationDefinitionsBlock5Base : IGuerilla
    {
        ...
        internal VocalizationDefinitionsBlock5Base( BinaryReader binaryReader )
        {
