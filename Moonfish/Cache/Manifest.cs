...
namespace Moonfish
{
    ...
    public abstract class ManifestDictionary<TK, TV>
    {
        ...
        /// </summary>
        private readonly Dictionary<Ident, Info> entries;

        /// <summary>
        ///     Maps from internal package keys to manifest identifiers.
        /// </summary>
        private readonly Dictionary<TK, Ident> keymap;

        /// <summary>
        ///     Local values contained in this package.
        /// </summary>
        private readonly Dictionary<Ident, TV> localValues;
        ...
        public struct Info
        {
            ...
            /// <summary>
            ///     Gets a value indicating whether this <see cref="T:Moonfish.ManifestDictionary`2.Info" /> is internal.
            /// </summary>
    ...
    public class LocalizationManifest :
        ManifestDictionary<StringIdent, ICollection<string>>
    {
    }
