...
namespace Moonfish.Graphics
{
    ...
    /// </summary>
    public class Mesh : IDisposable, IEnumerable<VertexArrayObject>
    {
            ...
            GlobalGeometryCompressionInfoBlock compressionInfo)
        {
            Parts = parts;
            SubParts = subParts;
            TriangleBatch = new VertexArrayObject();
        ...
        public VertexArrayObject TriangleBatch { get; private set; }
        ...
        IEnumerator<VertexArrayObject> IEnumerable<VertexArrayObject>.GetEnumerator()
        {
        ...
        {
            return ((IEnumerable<VertexArrayObject>)this).GetEnumerator();
        }
    ...
    public struct BucketAttributes
    {
        public int BufferSize;
        public GlobalGeometryPartBlockNew.TypeEnum GeometryType;
        public VertexAttributeType[] SupportedVertexAttributes;
    }
