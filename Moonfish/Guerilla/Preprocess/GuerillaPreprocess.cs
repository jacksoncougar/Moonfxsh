...
{
    /// <summary>
    ///     Collection of Preprocessing functions which are called via reflection on
    ///     the named blocks when they are being created.
    /// </summary>
    [UsedImplicitly(ImplicitUseTargetFlags.WithMembers)]
    internal class GuerillaPreprocess
    {
        /// <summary>
        ///     (1) Removes the last padding field to fix the size of the struct for
        ///     xbox
        /// </summary>
        ...
        /// <summary>
        ///     (1) Updates the names of some enums, and changes around some value names to
        ///     make them valid identifiers. (2) Removes something called WDPfields.
        /// </summary>
        ...
        {
            ((MoonfishTagEnumDefinition) fields[2].Definition).Names =
                new List<string>(new[] {"TextureArray2D", "TextureArray3D", "Cubemaps", "Sprites", "Interface Bitmaps"});
            ((MoonfishTagEnumDefinition) fields[4].Definition).Names =
                new List<string>(new[]
                {
                    "Compressed with Color-Key Transparency", "Compressed with Explicit Alpha",
                    "Compressed with Interpolated Alpha", "Color 16-Bit", "Color 32-Bit", "Monochrome"
                });
            ...
            var index =
                (from field in fields where field.Strings.Name == "WDP fields" select fields.IndexOf(field)).Single();

            MoonfishTagField[] wdpFields =
        ...
        /// <summary>
        ///     (1) Changes the names of the Type enum values. (2) Convert some padding
        ///     fields into the bitmap raw offset and address fields.
        /// </summary>
        ...
        /// <summary>(1) Removes 4 bytes of padding from the end of the block.</summary>
        ...
        protected static IList<MoonfishTagField> PreprocessCollisionBSPPhysicsBlockFields(IList<MoonfishTagField> fields)
        {
            ...
            fields.Insert(fields.IndexOf(fields.Last()), new MoonfishTagField(MoonfishFieldType.FieldPad, "padding", 4));

            return fields;
        }

        [GuerillaPreProcessFieldsMethod(BlockName = "decal_vertices_block")]
        protected static IList<MoonfishTagField> PreprocessDecalVerticesBlockFields(IList<MoonfishTagField> fields)
        {
            fields.Insert(4, new MoonfishTagField(MoonfishFieldType.FieldPad, "padding", 1));
            return fields;
        }

        /// <summary>(1) Removes 8 bytes of padding from the end of the block.</summary>
        ...
        protected static IList<MoonfishTagField> PreprocessDecoratorPermutationsBlockFields(
            IList<MoonfishTagField> fields)
        {
            fields.Insert(10, new MoonfishTagField(MoonfishFieldType.FieldPad, "padding", 2));
            return fields;
        }

        [GuerillaPreProcessFieldsMethod(BlockName = "decorator_placement_block")]
        protected static IList<MoonfishTagField> PreprocessDecoratorPlacementBlockFields(IList<MoonfishTagField> fields)
        {
            fields.Insert(4, new MoonfishTagField(MoonfishFieldType.FieldPad, "padding", 2));
            return fields;
        }

        /// <summary>
        ///     (1) Partially rewrites the Sounds references block. (2) Partially
        ///     rewrites unicode table struct.
        /// </summary>
        ...
        protected static IList<MoonfishTagField> PreprocessGlobalsBlockFields(IList<MoonfishTagField> fields)
        {
            ...
            field.AssignDefinition(new MoonfishTagDefinition("Moonfish Sound References Block",
                new List<MoonfishTagField> {soundTagReferenceField}));
            fields[8] = field;

            var unicodeStruct = new MoonfishTagField(MoonfishFieldType.FieldStruct, "UnicodeBlockInfo");
            unicodeStruct.AssignDefinition(
                new MoonfishTagStruct(new MoonfishTagDefinition("MoonfishGlobalUnicodeBlockInfoStructBlock",
                    new[]
                    {
        ...
        {
            fields.Insert(3, new MoonfishTagField(MoonfishFieldType.FieldPad, "padding", 1));
            return fields;
        }

        /// <summary>
        ///     (1) Inserts 4 bytes of padding ("indexer") after the "Object Data"
        ///     field.
        /// </summary>
        ...
        {
            var index =
                (from field in fields where field.Strings.Name == "Object Data" select fields.IndexOf(field)).Single();
        ...
        /// <summary>
        ///     (1) Adds a new unmapped block "Xbox Unknown Animation Block" to the end of
        ///     the struct. (2) Adds a new raw reference block "Xbox Animation Data Block"
        ...
        /// <summary>(1) Updates the names of an enum definition so they are valid.</summary>
        ...
        /// <summary>(1) Inserts a padding byte into the field</summary>
        ...
        /// <summary>(1) Inserts 2 padding bytes at the end of the block.</summary>
        [GuerillaPreProcessFieldsMethod(BlockName = "scenario_cutscene_title_block")]
        protected static IList<MoonfishTagField> PreprocessScenarioCutsceneTitleBlockFields(
            IList<MoonfishTagField> fields)
        {
            fields.Insert(6, new MoonfishTagField(MoonfishFieldType.FieldPad, "padding", 2));

            return fields;
        }

        [GuerillaPreProcessFieldsMethod(BlockName = "scenario_object_permutation_struct_block")]
        protected static IList<MoonfishTagField> PreprocessScenarioObjectPermutationStructBlockFields(
            IList<MoonfishTagField> fields)
        {
            return fields;
        }

        /// <summary>(1) Fills out the header of the BSP reference block.</summary>
        [GuerillaPreProcessFieldsMethod(BlockName = "scenario_structure_bsp_reference_block")]
        protected static IList<MoonfishTagField> PreprocessScenarioStructureBspReferenceBlockFields(
            IList<MoonfishTagField> fields)
        {
            ...
            blockInfoStruct.AssignDefinition(
                new MoonfishTagStruct(new MoonfishTagDefinition("MoonfishGlobalStructureBlockInfoStructBlock",
                    new[]
                    {
                        new MoonfishTagField(MoonfishFieldType.FieldLongInteger, "Block Offset"),
        ...
        /// <summary>(1) Removes the postprocess properties block entirely.</summary>
        ...
        /// <summary>(1) Removes three blocks from the end of the block.</summary>
        [GuerillaPreProcessFieldsMethod(BlockName = "shader_pass_postprocess_implementation_new_block")]
        protected static IList<MoonfishTagField> PreprocessShaderPassPostProcessImplementationNewBlockFields(
            IList<MoonfishTagField> fields)
        {
            fields.RemoveAt(fields.Count - 2);
            fields.RemoveAt(fields.Count - 2);
        ...
        /// <summary>(1) Changes the types of the first field to a Ident.</summary>
        /// <param name="fields"></param>
        /// <returns></returns>
        ...
        /// <summary>(1) Updates the type of the first field to a <see cref="TagIdent" />.</summary>
        [GuerillaPreProcessFieldsMethod(BlockName = "shader_postprocess_bitmap_new_block")]
        ...
        [GuerillaPreProcessFieldsMethod(BlockName = "shader_state_misc_state_block")]
        protected static IList<MoonfishTagField> PreprocessShaderStateMiscStateBlockFields(
            IList<MoonfishTagField> fields)
        {
            fields.Insert(3, new MoonfishTagField(MoonfishFieldType.FieldPad, "padding", 1));
            return fields;
        ...
        /// <summary>(1) Changes a padding field into actual values.</summary>
        ...
        [GuerillaPreProcessFieldsMethod(BlockName = "shader_texture_state_kill_state_block")]
        protected static IList<MoonfishTagField> PreprocessShaderTextureStateKillStateBlockFields(
            IList<MoonfishTagField> fields)
        {
            fields.Insert(5, new MoonfishTagField(MoonfishFieldType.FieldPad, "padding", 1));
            return fields;
        }

        /// <summary>(1) Replaces the entire block with a null implementation.</summary>
        ...
        /// <summary>
        ///     (1) Creates new block "Sound Promotion Rule Block" (2) Creates new block
        ///     "Sound Promotion Runtime Timer Block" (3) Returns a new fieldset created
        ///     from those previous two.
        /// </summary>
        [GuerillaPreProcessFieldsMethod(BlockName = "sound_gestalt_promotions_block")]
        protected static IList<MoonfishTagField> PreprocessSoundGestaltPromotionBlockFields(
            IList<MoonfishTagField> fields)
        {
            ...
            return new[]
            {
                soundPromotionRuleBlockField, soundPromotionRuntimeTimerBlockField,
                new MoonfishTagField(MoonfishFieldType.FieldPad, "", 12),
                new MoonfishTagField(MoonfishFieldType.FieldTerminator, "")
            };
        }

        [GuerillaPreProcessFieldsMethod(BlockName = "sprite_vertices_block")]
        protected static IList<MoonfishTagField> PreprocessSpriteVerticesBlockFields(IList<MoonfishTagField> fields)
        {
            fields.Insert(5, new MoonfishTagField(MoonfishFieldType.FieldPad, "padding", 1));
            return fields;
        }

        /// <summary>(1) Removes the Halo 2 vista mouse blocks.</summary>
        [GuerillaPreProcessFieldsMethod(BlockName = "user_interface_screen_widget_definition_block")]
        protected static IList<MoonfishTagField> PreprocessUserInterfaceScreenWidgetDefinitionBlockFields(
            IList<MoonfishTagField> fields)
        {
        ...
        /// <summary>(1) Removes a field from the block.</summary>
        ...
        /// <summary>
        ///     (1) Updates element size of data field. (2) Inserts a new padding
        ///     field of 8 bytes.
        /// </summary>
        [GuerillaPreProcessFieldsMethod(BlockName = "vertex_shader_classification_block")]
        protected static IList<MoonfishTagField> PreprocessVertexShaderClassificationBlockFields(
            IList<MoonfishTagField> fields)
        {
