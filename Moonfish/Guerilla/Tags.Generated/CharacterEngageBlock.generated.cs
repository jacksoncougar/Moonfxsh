...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class CharacterEngageBlock : GuerillaBlock, IWriteDeferrable
    {
        ...
        {
            base.Write(writer);
            writer.Write(((int)(this.CharacterEngageFlags)));
            writer.Write(this.CrouchDangerThreshold);
            writer.Write(this.StandDangerThreshold);
            writer.Write(this.FightDangerMoveThreshold);
        }
