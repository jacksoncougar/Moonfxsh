...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class CharacterGeneralBlock : GuerillaBlock, IWriteDeferrable
    {
        ...
        {
            base.Write(writer);
            writer.Write(((int)(this.CharacterGeneralGeneralFlags)));
            writer.Write(((short)(this.Type)));
            writer.Write(this.fieldpad);
            writer.Write(this.Scariness);
        }
