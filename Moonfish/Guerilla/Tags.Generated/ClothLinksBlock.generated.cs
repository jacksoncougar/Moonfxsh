...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class ClothLinksBlock : GuerillaBlock, IWriteQueueable
    {
        ...
        public override void Write_(Moonfish.Guerilla.QueueableBlamBinaryWriter queueableBlamBinaryWriter)
        {
            ...
            queueableBlamBinaryWriter.Write(this.AttachmentBits);
            queueableBlamBinaryWriter.Write(this.Index1);
            queueableBlamBinaryWriter.Write(this.Index2);
            queueableBlamBinaryWriter.Write(this.DefaultDistance);
            queueableBlamBinaryWriter.Write(this.DampingMultiplier);
        }
    }
}
