...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class DamageEffectSoundEffectDefinitionBlock : GuerillaBlock, IWriteQueueable
    {
        ...
        public override void QueueWrites(Moonfish.Guerilla.QueueableBlamBinaryWriter queueableBlamBinaryWriter)
        {
            ...
            this.EffectScaleFunction.QueueWrites(queueableBlamBinaryWriter);
        }
        public override void Write_(Moonfish.Guerilla.QueueableBlamBinaryWriter queueableBlamBinaryWriter)
        {
            base.Write_(queueableBlamBinaryWriter);
            queueableBlamBinaryWriter.Write(this.EffectName);
            queueableBlamBinaryWriter.Write(this.Duration);
            this.EffectScaleFunction.Write_(queueableBlamBinaryWriter);
        }
    }
}
