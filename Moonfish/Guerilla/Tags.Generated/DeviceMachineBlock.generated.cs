...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class DeviceMachineBlock : DeviceBlock, IWriteQueueable
    {
        ...
        public override void Write_(Moonfish.Guerilla.QueueableBlamBinaryWriter queueableBlamBinaryWriter)
        {
            ...
            queueableBlamBinaryWriter.Write(((short)(this.DeviceMachineDeviceMachineFlags)));
            queueableBlamBinaryWriter.Write(this.DoorOpenTime);
            queueableBlamBinaryWriter.Write(this.DoorOcclusionBounds);
            queueableBlamBinaryWriter.Write(((short)(this.CollisionResponse)));
            queueableBlamBinaryWriter.Write(this.ElevatorNode);
