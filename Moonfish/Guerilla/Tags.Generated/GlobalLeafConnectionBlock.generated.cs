...
namespace Moonfish.Guerilla.Tags
{
    ...
    [TagBlockOriginalNameAttribute("global_leaf_connection_block")]
    public partial class GlobalLeafConnectionBlock : GuerillaBlock, IWriteDeferrable
    {
        ...
        {
            base.Write(writer);
            writer.Write(this.PlaneIndex);
            writer.Write(this.BackLeafIndex);
            writer.Write(this.FrontLeafIndex);
