...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class HudGlobalsBlock : GuerillaBlock, IWriteDeferrable
    {
        ...
        public override void Write(Moonfish.Guerilla.LinearBinaryWriter writer)
        {
            ...
            writer.Write(((short)(this.HudGlobalsScalingFlags)));
            ...
            writer.Write(this.IconColor);
            writer.Write(this.TextColor);
            writer.Write(this.TextSpacing);
            writer.Write(this.ItemMessageText);
            writer.Write(this.IconBitmap);
            writer.Write(this.AlternateIconText);
            writer.WritePointer(this.ButtonIcons);
            ...
            writer.Write(((short)(this.HudGlobalsFlashFlags)));
            ...
            writer.Write(((short)(this.HudGlobalsHudGlobalsFlashFlags0)));
            writer.Write(this.FlashLength0);
            writer.Write(this.DisabledColor0);
            writer.Write(this.UptimeTicks);
            writer.Write(this.FadeTicks);
            ...
            writer.Write(this.ArrowBitmap);
            writer.WritePointer(this.WaypointArrows);
            writer.Write(this.fieldpad5);
            writer.Write(this.HudScaleInMultiplayer);
            writer.Write(this.fieldpad6);
            writer.Write(this.fieldpad7);
            writer.Write(this.MotionSensorRange);
            writer.Write(this.MotionSensorVelocitySensitivity);
            writer.Write(this.MotionSensorScaleDONTTOUCHEVER);
            writer.Write(this.DefaultChapterTitleBounds);
            writer.Write(this.fieldpad8);
            writer.Write(this.TopOffset0);
            writer.Write(this.BottomOffset0);
            writer.Write(this.LeftOffset0);
            writer.Write(this.RightOffset0);
            writer.Write(this.fieldpad9);
            writer.Write(this.IndicatorBitmap);
            writer.Write(this.SequenceIndex);
            writer.Write(this.MultiplayerSequenceIndex);
            ...
            writer.Write(((short)(this.HudGlobalsHudGlobalsFlashFlags1)));
            ...
            writer.Write(((short)(this.HudGlobalsHudGlobalsFlashFlags2)));
            writer.Write(this.FlashLength2);
            writer.Write(this.DisabledColor2);
            writer.Write(this.fieldpad12);
            writer.Write(this.fieldpad13);
            writer.Write(this.CarnageReportBitmap);
            writer.Write(this.LoadingBeginText);
            writer.Write(this.LoadingEndText);
            writer.Write(this.CheckpointBeginText);
            writer.Write(this.CheckpointEndText);
            writer.Write(this.CheckpointSound);
            writer.Write(this.fieldpad14);
            this.NewGlobals.Write(writer);
        }
