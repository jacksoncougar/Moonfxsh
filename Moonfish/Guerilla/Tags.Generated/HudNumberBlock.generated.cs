...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class HudNumberBlock : GuerillaBlock, IWriteDeferrable
    {
        ...
        {
            base.Write(writer);
            writer.Write(this.DigitsBitmap);
            writer.Write(this.BitmapDigitWidth);
            writer.Write(this.ScreenDigitWidth);
            writer.Write(this.XOffset);
            writer.Write(this.YOffset);
            writer.Write(this.DecimalPointWidth);
            writer.Write(this.ColonWidth);
