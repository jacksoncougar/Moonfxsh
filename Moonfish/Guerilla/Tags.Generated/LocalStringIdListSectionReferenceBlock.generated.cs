...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class LocalStringIdListSectionReferenceBlock : GuerillaBlock, IWriteQueueable
    {
        ...
        public override void QueueWrites(Moonfish.Guerilla.QueueableBlamBinaryWriter queueableBlamBinaryWriter)
        {
            ...
            queueableBlamBinaryWriter.QueueWrite(this.LocalStringSectionReferences);
        }
        public override void Write_(Moonfish.Guerilla.QueueableBlamBinaryWriter queueableBlamBinaryWriter)
        {
            base.Write_(queueableBlamBinaryWriter);
            queueableBlamBinaryWriter.Write(this.SectionName);
            queueableBlamBinaryWriter.WritePointer(this.LocalStringSectionReferences);
        }
    }
}
