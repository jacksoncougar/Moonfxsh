...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class PhysicsModelBlock : GuerillaBlock, IWriteQueueable
    {
        ...
        public override void QueueWrites(Moonfish.Guerilla.QueueableBlamBinaryWriter queueableBlamBinaryWriter)
        {
            ...
            queueableBlamBinaryWriter.QueueWrite(this.PhantomTypes);
            queueableBlamBinaryWriter.QueueWrite(this.NodeEdges);
            queueableBlamBinaryWriter.QueueWrite(this.RigidBodies);
            queueableBlamBinaryWriter.QueueWrite(this.Materials);
            queueableBlamBinaryWriter.QueueWrite(this.Spheres);
            queueableBlamBinaryWriter.QueueWrite(this.MultiSpheres);
            queueableBlamBinaryWriter.QueueWrite(this.Pills);
            queueableBlamBinaryWriter.QueueWrite(this.Boxes);
            queueableBlamBinaryWriter.QueueWrite(this.Triangles);
            queueableBlamBinaryWriter.QueueWrite(this.Polyhedra);
            queueableBlamBinaryWriter.QueueWrite(this.PolyhedronFourVectors);
            queueableBlamBinaryWriter.QueueWrite(this.PolyhedronPlaneEquations);
            queueableBlamBinaryWriter.QueueWrite(this.MassDistributions);
            queueableBlamBinaryWriter.QueueWrite(this.Lists);
            queueableBlamBinaryWriter.QueueWrite(this.ListShapes);
            queueableBlamBinaryWriter.QueueWrite(this.Mopps);
            queueableBlamBinaryWriter.QueueWrite(this.MoppCodes);
            queueableBlamBinaryWriter.QueueWrite(this.HingeConstraints);
            queueableBlamBinaryWriter.QueueWrite(this.RagdollConstraints);
            ...
            queueableBlamBinaryWriter.QueueWrite(this.PointToPathCurves);
            queueableBlamBinaryWriter.QueueWrite(this.LimitedHingeConstraints);
            queueableBlamBinaryWriter.QueueWrite(this.BallAndSocketConstraints);
            queueableBlamBinaryWriter.QueueWrite(this.StiffSpringConstraints);
            queueableBlamBinaryWriter.QueueWrite(this.PrismaticConstraints);
            queueableBlamBinaryWriter.QueueWrite(this.Phantoms);
        }
        public override void Write_(Moonfish.Guerilla.QueueableBlamBinaryWriter queueableBlamBinaryWriter)
        {
            base.Write_(queueableBlamBinaryWriter);
            queueableBlamBinaryWriter.Write(((int)(this.PhysicsModelFlags)));
            queueableBlamBinaryWriter.Write(this.Mass);
            queueableBlamBinaryWriter.Write(this.LowFreqDeactivationScale);
            queueableBlamBinaryWriter.Write(this.HighFreqDeactivationScale);
            queueableBlamBinaryWriter.Write(this.fieldpad);
            queueableBlamBinaryWriter.WritePointer(this.PhantomTypes);
            queueableBlamBinaryWriter.WritePointer(this.NodeEdges);
            queueableBlamBinaryWriter.WritePointer(this.RigidBodies);
            queueableBlamBinaryWriter.WritePointer(this.Materials);
            queueableBlamBinaryWriter.WritePointer(this.Spheres);
            queueableBlamBinaryWriter.WritePointer(this.MultiSpheres);
            queueableBlamBinaryWriter.WritePointer(this.Pills);
            queueableBlamBinaryWriter.WritePointer(this.Boxes);
            queueableBlamBinaryWriter.WritePointer(this.Triangles);
            queueableBlamBinaryWriter.WritePointer(this.Polyhedra);
            queueableBlamBinaryWriter.WritePointer(this.PolyhedronFourVectors);
            queueableBlamBinaryWriter.WritePointer(this.PolyhedronPlaneEquations);
            queueableBlamBinaryWriter.WritePointer(this.MassDistributions);
            queueableBlamBinaryWriter.WritePointer(this.Lists);
            queueableBlamBinaryWriter.WritePointer(this.ListShapes);
            queueableBlamBinaryWriter.WritePointer(this.Mopps);
            queueableBlamBinaryWriter.WritePointer(this.MoppCodes);
            queueableBlamBinaryWriter.WritePointer(this.HingeConstraints);
            queueableBlamBinaryWriter.WritePointer(this.RagdollConstraints);
            ...
            queueableBlamBinaryWriter.WritePointer(this.PointToPathCurves);
            queueableBlamBinaryWriter.WritePointer(this.LimitedHingeConstraints);
            queueableBlamBinaryWriter.WritePointer(this.BallAndSocketConstraints);
            queueableBlamBinaryWriter.WritePointer(this.StiffSpringConstraints);
            queueableBlamBinaryWriter.WritePointer(this.PrismaticConstraints);
            queueableBlamBinaryWriter.WritePointer(this.Phantoms);
        }
