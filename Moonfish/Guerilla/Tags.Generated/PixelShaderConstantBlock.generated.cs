...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class PixelShaderConstantBlock : GuerillaBlock, IWriteDeferrable
    {
        ...
        {
            base.Write(writer);
            writer.Write(((byte)(this.ParameterType)));
            writer.Write(this.CombinerIndex);
            writer.Write(this.RegisterIndex);
            writer.Write(((byte)(this.ComponentMask)));
