...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class PlatformSoundEffectTemplateComponentBlock : GuerillaBlock, IWriteQueueable
    {
        ...
        public override void Write_(Moonfish.Guerilla.QueueableBlamBinaryWriter queueableBlamBinaryWriter)
        {
            ...
            queueableBlamBinaryWriter.Write(((int)(this.ValueType)));
            queueableBlamBinaryWriter.Write(this.DefaultValue);
            queueableBlamBinaryWriter.Write(this.MinimumValue);
            queueableBlamBinaryWriter.Write(this.MaximumValue);
        }
