...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class RasterizerScreenEffectConvolutionBlock : GuerillaBlock, IWriteQueueable
    {
        ...
        public override void Write_(Moonfish.Guerilla.QueueableBlamBinaryWriter queueableBlamBinaryWriter)
        {
            ...
            queueableBlamBinaryWriter.Write(((short)(this.RasterizerScreenEffectConvolutionFlags)));
            queueableBlamBinaryWriter.Write(this.fieldpad);
            queueableBlamBinaryWriter.Write(this.fieldpad0);
            queueableBlamBinaryWriter.Write(this.ConvolutionAmount);
            queueableBlamBinaryWriter.Write(this.FilterScale);
            queueableBlamBinaryWriter.Write(this.FilterBoxFactor);
            queueableBlamBinaryWriter.Write(this.ZoomFalloffRadius);
            queueableBlamBinaryWriter.Write(this.ZoomCutoffRadius);
            queueableBlamBinaryWriter.Write(this.ResolutionScale);
        }
        /// <summary>
