...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class ScenarioDescriptionBlock : GuerillaBlock, IWriteDeferrable
    {
        /// <summary>
        ...
        {
            base.Write(writer);
            writer.Write(this.DescriptiveBitmap);
            writer.Write(this.DisplayedMapName);
            writer.Write(this.ScenarioTagDirectoryPath);
