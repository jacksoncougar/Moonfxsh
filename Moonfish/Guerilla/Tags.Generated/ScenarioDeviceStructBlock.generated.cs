...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class ScenarioDeviceStructBlock : GuerillaBlock, IWriteDeferrable
    {
        ...
        {
            base.Write(writer);
            writer.Write(this.PowerGroup);
            writer.Write(this.PositionGroup);
            writer.Write(((int)(this.ScenarioDeviceStructFlags)));
        }
