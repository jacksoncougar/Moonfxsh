...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class ScenarioDeviceStructBlock : GuerillaBlock, IWriteQueueable
    {
        ...
        public override void Write_(Moonfish.Guerilla.QueueableBlamBinaryWriter queueableBlamBinaryWriter)
        {
            ...
            queueableBlamBinaryWriter.Write(this.PowerGroup);
            queueableBlamBinaryWriter.Write(this.PositionGroup);
            queueableBlamBinaryWriter.Write(((int)(this.ScenarioDeviceStructFlags)));
        }
