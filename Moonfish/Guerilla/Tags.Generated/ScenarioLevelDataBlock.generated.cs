...
namespace Moonfish.Guerilla.Tags
{
    ...
    [TagBlockOriginalNameAttribute("scenario_level_data_block")]
    public partial class ScenarioLevelDataBlock : GuerillaBlock, IWriteDeferrable
    {
        ...
        public override void DeferReferences(Moonfish.Guerilla.LinearBinaryWriter writer)
        {
            ...
            writer.Defer(this.CampaignLevelData);
            writer.Defer(this.Multiplayer);
        }
        public override void Write(Moonfish.Guerilla.LinearBinaryWriter writer)
        {
            base.Write(writer);
            writer.Write(this.LevelDescription);
            writer.WritePointer(this.CampaignLevelData);
            writer.WritePointer(this.Multiplayer);
        }
    }
}
