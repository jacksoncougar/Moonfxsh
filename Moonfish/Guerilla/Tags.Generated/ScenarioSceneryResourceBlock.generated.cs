...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class ScenarioSceneryResourceBlock : GuerillaBlock, IWriteDeferrable
    {
        ...
        public override void DeferReferences(Moonfish.Guerilla.LinearBinaryWriter writer)
        {
            ...
            writer.Defer(this.Palette0);
            writer.Defer(this.Objects0);
        ...
        public override void Write(Moonfish.Guerilla.LinearBinaryWriter writer)
        {
            ...
            writer.Write(this.NextSceneryObjectIDSalt);
            writer.WritePointer(this.Palette0);
            writer.WritePointer(this.Objects0);
            writer.Write(this.NextBlockObjectIDSalt);
