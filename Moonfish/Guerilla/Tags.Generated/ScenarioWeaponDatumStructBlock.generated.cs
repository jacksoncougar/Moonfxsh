...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class ScenarioWeaponDatumStructBlock : GuerillaBlock, IWriteDeferrable
    {
        ...
        {
            base.Write(writer);
            writer.Write(this.RoundsLeft);
            writer.Write(this.RoundsLoaded);
            writer.Write(((int)(this.ScenarioWeaponDatumStructFlags)));
        }
