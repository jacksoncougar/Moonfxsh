...
namespace Moonfish.Guerilla.Tags
{
    ...
    [TagBlockOriginalNameAttribute("scenario_weapons_resource_block")]
    public partial class ScenarioWeaponsResourceBlock : GuerillaBlock, IWriteDeferrable
    {
        ...
        public ScenarioWeaponPaletteBlock[] Palette = new ScenarioWeaponPaletteBlock[0];
        public ScenarioWeaponBlock[] Objects = new ScenarioWeaponBlock[0];
        ...
        public override void ReadInstances(Moonfish.Guerilla.BlamBinaryReader binaryReader, System.Collections.Generic.Queue<Moonfish.Tags.BlamPointer> pointerQueue)
        {
            ...
            this.Palette = base.ReadBlockArrayData<ScenarioWeaponPaletteBlock>(binaryReader, pointerQueue.Dequeue());
            this.Objects = base.ReadBlockArrayData<ScenarioWeaponBlock>(binaryReader, pointerQueue.Dequeue());
...
namespace Moonfish.Tags
{
    ...
    {
        public static TagClass Eap = ((TagClass)("*eap"));
    }
}
