...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class SecondaryLightStructBlock : GuerillaBlock, IWriteQueueable
    {
        ...
        public override void Write_(Moonfish.Guerilla.QueueableBlamBinaryWriter queueableBlamBinaryWriter)
        {
            ...
            queueableBlamBinaryWriter.Write(this.MinLightmapColor);
            queueableBlamBinaryWriter.Write(this.MaxLightmapColor);
            queueableBlamBinaryWriter.Write(this.MinDiffuseSample);
            queueableBlamBinaryWriter.Write(this.MaxDiffuseSample);
            queueableBlamBinaryWriter.Write(this.ZAxisRotation);
