...
namespace Moonfish.Guerilla.Tags
{
    ...
    [TagBlockOriginalNameAttribute("shader_pass_vertex_shader_constant_block")]
    public partial class ShaderPassVertexShaderConstantBlock : GuerillaBlock, IWriteDeferrable
    {
        ...
        public override void Write(Moonfish.Guerilla.LinearBinaryWriter writer)
        {
            ...
            writer.Write(((short)(this.ScaleByTextureStage)));
            writer.Write(((short)(this.RegisterBank)));
            writer.Write(this.RegisterIndex);
            writer.Write(((short)(this.ComponentMask)));
        }
