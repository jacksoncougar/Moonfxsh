...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class ShaderStateAlphaTestStateBlock : GuerillaBlock, IWriteDeferrable
    {
        ...
        {
            base.Write(writer);
            writer.Write(((short)(this.ShaderStateAlphaTestStateFlags)));
            writer.Write(((short)(this.AlphaCompareFunction)));
            writer.Write(this.AlphatestRef);
