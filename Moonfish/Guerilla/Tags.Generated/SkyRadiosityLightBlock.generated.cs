...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class SkyRadiosityLightBlock : GuerillaBlock, IWriteQueueable
    {
        ...
        public override void Write_(Moonfish.Guerilla.QueueableBlamBinaryWriter queueableBlamBinaryWriter)
        {
            ...
            queueableBlamBinaryWriter.Write(((int)(this.SkyRadiosityLightFlags)));
            queueableBlamBinaryWriter.Write(this.Color);
            queueableBlamBinaryWriter.Write(this.Power);
            queueableBlamBinaryWriter.Write(this.TestDistance);
            queueableBlamBinaryWriter.Write(this.fieldpad);
            queueableBlamBinaryWriter.Write(this.Diameter);
        }
