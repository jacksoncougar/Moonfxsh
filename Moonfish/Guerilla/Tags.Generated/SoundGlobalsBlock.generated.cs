...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class SoundGlobalsBlock : GuerillaBlock, IWriteDeferrable
    {
        ...
        {
            base.Write(writer);
            writer.Write(this.SoundClasses);
            writer.Write(this.SoundEffects);
            writer.Write(this.SoundMix);
            writer.Write(this.SoundCombatDialogueConstants);
