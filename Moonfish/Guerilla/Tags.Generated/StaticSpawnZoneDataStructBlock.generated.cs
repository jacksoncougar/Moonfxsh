...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class StaticSpawnZoneDataStructBlock : GuerillaBlock, IWriteQueueable
    {
        ...
        public override void Write_(Moonfish.Guerilla.QueueableBlamBinaryWriter queueableBlamBinaryWriter)
        {
            ...
            queueableBlamBinaryWriter.Write(((int)(this.StaticSpawnZoneDataStructRelevantTeam)));
            queueableBlamBinaryWriter.Write(((int)(this.StaticSpawnZoneDataStructRelevantGames)));
            queueableBlamBinaryWriter.Write(((int)(this.StaticSpawnZoneDataStructFlags)));
        }
