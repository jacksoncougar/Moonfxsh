...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class StructureBspEnvironmentObjectBlock : GuerillaBlock, IWriteQueueable
    {
        ...
        public override void Write_(Moonfish.Guerilla.QueueableBlamBinaryWriter queueableBlamBinaryWriter)
        {
            ...
            queueableBlamBinaryWriter.Write(this.PaletteIndex);
            queueableBlamBinaryWriter.Write(this.fieldpad);
            queueableBlamBinaryWriter.Write(this.UniqueID);
            queueableBlamBinaryWriter.Write(this.ExportedObjectType);
            queueableBlamBinaryWriter.Write(this.ScenarioObjectName);
        }
    }
}
