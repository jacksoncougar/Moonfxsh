...
namespace Moonfish.Guerilla.Tags
{
    ...
    [TagBlockOriginalNameAttribute("structure_bsp_weather_palette_block")]
    public partial class StructureBspWeatherPaletteBlock : GuerillaBlock, IWriteDeferrable
    {
        ...
        public override void Write(Moonfish.Guerilla.LinearBinaryWriter queueableBinaryWriter)
        {
            ...
            queueableBinaryWriter.Write(this.WeatherSystem);
            queueableBinaryWriter.Write(this.fieldpad);
            queueableBinaryWriter.Write(this.fieldpad0);
            queueableBinaryWriter.Write(this.fieldpad1);
            queueableBinaryWriter.Write(this.Wind);
            queueableBinaryWriter.Write(this.WindDirection);
            queueableBinaryWriter.Write(this.WindMagnitude);
            queueableBinaryWriter.Write(this.fieldpad2);
            queueableBinaryWriter.Write(this.WindScaleFunction);
        }
    }
}
