...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class StructureBspWeatherPaletteBlock : GuerillaBlock, IWriteDeferrable
    {
        ...
        public override void Write(Moonfish.Guerilla.LinearBinaryWriter writer)
        {
            ...
            writer.Write(this.WeatherSystem);
            writer.Write(this.fieldpad);
            writer.Write(this.fieldpad0);
            writer.Write(this.fieldpad1);
            writer.Write(this.Wind);
            writer.Write(this.WindDirection);
            writer.Write(this.WindMagnitude);
            writer.Write(this.fieldpad2);
            writer.Write(this.WindScaleFunction);
        }
    }
}
