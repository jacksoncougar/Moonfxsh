...
namespace Moonfish.Guerilla.Tags
{
    ...
    [TagBlockOriginalNameAttribute("text_value_pair_definition_block")]
    public partial class TextValuePairDefinitionBlock : GuerillaBlock, IWriteDeferrable
    {
        ...
        {
            base.Write(writer);
            writer.Write(((int)(this.Parameter)));
            writer.Write(this.fieldpad);
            writer.Write(this.StringList);
            writer.Write(this.TitleText);
            writer.Write(this.HeaderText);
            writer.Write(this.DescriptionText);
