...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class UnitBoostStructBlock : GuerillaBlock, IWriteQueueable
    {
        ...
        public override void Write_(Moonfish.Guerilla.QueueableBlamBinaryWriter queueableBlamBinaryWriter)
        {
            ...
            queueableBlamBinaryWriter.Write(this.BoostPeakPower);
            queueableBlamBinaryWriter.Write(this.BoostRisePower);
            queueableBlamBinaryWriter.Write(this.BoostPeakTime);
            queueableBlamBinaryWriter.Write(this.BoostFallPower);
            queueableBlamBinaryWriter.Write(this.DeadTime);
        }
    }
}
