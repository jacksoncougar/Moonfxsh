...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class UnitBoostStructBlock : GuerillaBlock, IWriteDeferrable
    {
        ...
        {
            base.Write(writer);
            writer.Write(this.BoostPeakPower);
            writer.Write(this.BoostRisePower);
            writer.Write(this.BoostPeakTime);
            writer.Write(this.BoostFallPower);
            writer.Write(this.DeadTime);
        }
    }
}
