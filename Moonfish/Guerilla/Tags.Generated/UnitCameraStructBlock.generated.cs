...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class UnitCameraStructBlock : GuerillaBlock, IWriteDeferrable
    {
        ...
        public override void DeferReferences(Moonfish.Guerilla.LinearBinaryWriter writer)
        {
            ...
            writer.Defer(this.CameraTracks);
        }
        public override void Write(Moonfish.Guerilla.LinearBinaryWriter writer)
        {
            base.Write(writer);
            writer.Write(this.CameraMarkerName);
            writer.Write(this.CameraSubmergedMarkerName);
            writer.Write(this.PitchAutolevel);
            writer.Write(this.PitchRange);
            writer.WritePointer(this.CameraTracks);
        }
    }
}
