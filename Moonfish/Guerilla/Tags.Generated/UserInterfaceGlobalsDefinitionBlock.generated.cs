...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class UserInterfaceGlobalsDefinitionBlock : GuerillaBlock, IWriteQueueable
    {
        ...
        public override void QueueWrites(Moonfish.Guerilla.QueueableBlamBinaryWriter queueableBlamBinaryWriter)
        {
            ...
            queueableBlamBinaryWriter.QueueWrite(this.ScreenWidgets);
        }
        public override void Write_(Moonfish.Guerilla.QueueableBlamBinaryWriter queueableBlamBinaryWriter)
        {
            base.Write_(queueableBlamBinaryWriter);
            queueableBlamBinaryWriter.Write(this.SharedGlobals);
            queueableBlamBinaryWriter.WritePointer(this.ScreenWidgets);
            queueableBlamBinaryWriter.Write(this.MpVariantSettingsUi);
            queueableBlamBinaryWriter.Write(this.GameHopperDescriptions);
        }
    }
}
