...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class WeaponBlock : ItemBlock, IWriteDeferrable
    {
        ...
        public override void DeferReferences(Moonfish.Guerilla.LinearBinaryWriter writer)
        {
            ...
            writer.Defer(this.NewTriggers);
            writer.Defer(this.Barrels);
        }
        public override void Write(Moonfish.Guerilla.LinearBinaryWriter writer)
        {
            base.Write(writer);
            writer.Write(((int)(this.WeaponWeaponFlags)));
            writer.Write(this.FieldOldStringId);
            writer.Write(((short)(this.SecondaryTriggerMode)));
            writer.Write(this.MaximumAlternateShotsLoaded);
            writer.Write(this.TurnOnTime);
            writer.Write(this.ReadyTime);
            writer.Write(this.ReadyEffect);
            writer.Write(this.ReadyDamageEffect);
            writer.Write(this.HeatRecoveryThreshold);
            writer.Write(this.OverheatedThreshold);
            writer.Write(this.HeatDetonationThreshold);
            writer.Write(this.HeatDetonationFraction);
            writer.Write(this.HeatLossPerSecond);
            writer.Write(this.HeatIllumination);
            writer.Write(this.OverheatedHeatLossPerSecond);
            writer.Write(this.Overheated);
            writer.Write(this.OverheatedDamageEffect);
            writer.Write(this.Detonation);
            writer.Write(this.DetonationDamageEffect0);
            writer.Write(this.PlayerMeleeDamage);
            writer.Write(this.PlayerMeleeResponse);
            this.MeleeAimAssist.Write(writer);
            this.MeleeDamageParameters.Write(writer);
            writer.Write(((byte)(this.MeleeDamageReportingType)));
            writer.Write(this.fieldpad3);
            writer.Write(this.MagnificationLevels);
            writer.Write(this.MagnificationRange);
            this.WeaponAimAssist.Write(writer);
            writer.Write(((short)(this.MovementPenalized)));
            writer.Write(this.fieldpad4);
            writer.Write(this.ForwardMovementPenalty);
            writer.Write(this.SidewaysMovementPenalty);
            writer.Write(this.AIScariness);
            writer.Write(this.WeaponPoweronTime);
            writer.Write(this.WeaponPoweroffTime);
            writer.Write(this.WeaponPoweronEffect);
            writer.Write(this.WeaponPoweroffEffect);
            writer.Write(this.AgeHeatRecoveryPenalty);
            writer.Write(this.AgeRateOfFirePenalty);
            writer.Write(this.AgeMisfireStart);
            writer.Write(this.AgeMisfireChance);
            writer.Write(this.PickupSound);
            writer.Write(this.ZoominSound);
            writer.Write(this.ZoomoutSound);
            writer.Write(this.ActiveCamoDing);
            writer.Write(this.ActiveCamoRegrowthRate);
            writer.Write(this.HandleNode);
            writer.Write(this.WeaponClass);
            writer.Write(this.WeaponName);
            writer.Write(((short)(this.MultiplayerWeaponType)));
            writer.Write(((short)(this.WeaponType)));
            this.Tracking.Write(writer);
            this.PlayerInterface.Write(writer);
            writer.WritePointer(this.PredictedResources0);
            writer.WritePointer(this.Magazines);
            writer.WritePointer(this.NewTriggers);
            writer.WritePointer(this.Barrels);
            writer.Write(this.fieldpad5);
            writer.Write(this.MaxMovementAcceleration);
            writer.Write(this.MaxMovementVelocity);
            writer.Write(this.MaxTurningAcceleration);
            writer.Write(this.MaxTurningVelocity);
            writer.Write(this.DeployedVehicle);
            writer.Write(this.AgeEffect);
            writer.Write(this.AgedWeapon);
            writer.Write(this.FirstPersonWeaponOffset);
            writer.Write(this.FirstPersonScopeSize);
        }
        /// <summary>
