...
namespace Moonfish.Guerilla.Tags
{
    ...
    public partial class WeaponHudCrosshairBlock : GuerillaBlock, IWriteDeferrable
    {
        ...
        public override void DeferReferences(Moonfish.Guerilla.LinearBinaryWriter writer)
        {
            ...
            writer.Defer(this.CrosshairOverlays);
        }
        public override void Write(Moonfish.Guerilla.LinearBinaryWriter writer)
        {
            base.Write(writer);
            writer.Write(((short)(this.CrosshairType)));
            writer.Write(this.fieldpad);
            writer.Write(((short)(this.CanUseOnMapType)));
            writer.Write(this.fieldpad0);
            writer.Write(this.fieldpad1);
            writer.Write(this.CrosshairBitmap);
            writer.WritePointer(this.CrosshairOverlays);
